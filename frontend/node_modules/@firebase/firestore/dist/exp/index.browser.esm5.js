...
var Ut = /** @class */ function(e) {
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.l(t, e, r) : new Bt(t, e, r) : "array-contains" /* ARRAY_CONTAINS */ === e ? new Gt(t, r) : "in" /* IN */ === e ? new zt(t, r) : "not-in" /* NOT_IN */ === e ? new Wt(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new Ht(t, r) : new n(t, e, r);
    }, n.l = function(t, e, n) {
...
var Bt = /** @class */ function(e) {
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, "in" /* IN */ , n) || this).keys = Qt("in" /* IN */ , n), 
        r;
    }
    return t(n, e), n.prototype.matches = function(t) {
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, "not-in" /* NOT_IN */ , n) || this).keys = Qt("not-in" /* NOT_IN */ , n), 
        r;
    }
    return t(n, e), n.prototype.matches = function(t) {
        return !this.keys.some((function(e) {
...
/** Filter that matches on key fields within an array. */ function Qt(t, e) {
    var n;
...
/** A Filter that implements the array-contains operator. */ var Gt = /** @class */ function(e) {
    function n(t, n) {
 ...
 */ function he(t) {
    var e = Q(t);
    if (!e.T) if ("F" /* First */ === e.limitType) e.T = Ft(e.path, e.collectionGroup, ce(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        ...
        // Now return as a LimitType.First query.
                e.T = Ft(e.path, e.collectionGroup, n, e.filters, e.limit, u, a);
    }
    return e.T;
}
 ...
 */ function Ve(t, e, n) {
    t instanceof Ke ? function(t, e, n) {
        ...
        if (Fe(t.precondition, e)) {
            ...
            i.setAll(Ge(t)), i.setAll(r), e.convertToFoundDocument(n.version, i).setHasCommittedMutations();
 ...
 */ function qe(t, e, n) {
    t instanceof Ke ? function(t, e, n) {
        ...
        if (Fe(t.precondition, e)) {
            ...
            i.setAll(Ge(t)), i.setAll(r), e.convertToFoundDocument(je(e), i).setHasLocalMutations();
        }
    }(t, e, n) : function(t, e) {
        Fe(t.precondition, e) && 
        ...
        this.G.forEach((function(r, i) {
            ...
            if (o) {
                if (r.current && qt(o.target)) {
                    ...
                    null !== e.H.get(s) || e.ut(i, s) || e.tt(i, s, Ot.newNoDocument(s, t));
                }
                r.O && (n.set(i, r.M()), r.L());
            }
        }));
...
function jn(t, e, n) {
    var r = Fn(t, e.name), i = Rn(e.updateTime), o = new Rt({
        mapValue: {
            fields: e.fields
        }
...
function Qn(t, e) {
    ...
    if (e.update) {
        e.update.name;
        var i = Fn(t, e.update.name), o = new Rt({
            mapValue: {
...
function zn(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = Mn(t, r), n.structuredQuery.from = [ {
        collectionId: e.collectionGroup,
        allDescendants: !0
    } ]) : (n.parent = Mn(t, r.popLast()), n.structuredQuery.from = [ {
...
var _r = e(e([], e(e([], e(e([], e(e([], [ fr.store, lr.store, dr.store, vr.store, gr.store, hr.store, br.store, wr.store ]), [ Tr.store ])), [ mr.store ])), [ Ir.store ])), [ Er.store, Sr.store ]), Nr = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.", Dr = /** @class */ function() {
    ...
    /** Deletes the specified database. */    return t.delete = function(t) {
        return V("SimpleDb", "Removing database:", t), Fr(window.indexedDB.deleteDatabase(t)).toPromise();
    }, 
 ...
 */ var Pr = /** @class */ function() {
    ...
    t.prototype.add = function(t) {
        return V("SimpleDb", "ADD", this.store.name, t, t), Fr(this.store.add(t));
    }, 
    /**
    ...
    t.prototype.get = function(t) {
        ...
        return V("SimpleDb", "DELETE", this.store.name, t), Fr(this.store.delete(t));
    }, 
    /**
    ...
    t.prototype.count = function() {
        return V("SimpleDb", "COUNT", this.store.name), Fr(this.store.count());
...
function Zr(t, e) {
    ...
    n = qt(e.target) ? Gn(t.Lt, e.target) : zn(t.Lt, e.target);
    // We can't store the resumeToken as a ByteString in IndexedDb, so we
    // convert it to a base64 string for storage.
    var o = e.resumeToken.toBase64();
    // lastListenSequenceNumber is always 0 until we do real GC.
        return new gr(e.targetId, Mt(e.target), r, o, e.sequenceNumber, i, n);
}
 ...
 */ var mi = /** @class */ function() {
    ...
    t.prototype.ee = function(t, e) {
        ...
        var n = Mt(e), r = IDBKeyRange.bound([ n, Number.NEGATIVE_INFINITY ], [ n, Number.POSITIVE_INFINITY ]), i = null;
        return wi(t).Ot({
            range: r,
 ...
 */ var Si = /** @class */ function() {
    ...
    return t.prototype.calculateTargetCount = function(t, e) {
        ...
        return this.calculateTargetCount(t, this.params.percentileToCollect).next((function(e) {
            ...
            return a = Date.now(), F() <= l.DEBUG && V("LruGarbageCollector", "LRU Garbage Collection\n\tCounted targets in " + (o - h) + "ms\n\tDetermined least recently used " + r + " in " + (s - o) + "ms\n\tRemoved " + i + " targets in " + (u - s) + "ms\n\tRemoved " + t + " documents in " + (a - u) + "ms\nTotal Duration: " + (a - h) + "ms"), 
            kr.resolve({
                didRun: !0,
 ...
 * limitations under the License.
 */
/** Performs database creation and schema upgrades. */ var Fi = /** @class */ function() {
    function t(t) {
        this.R = t;
    }
    /**
...
var Vi = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", qi = /** @class */ function() {
    ...
    h) {
        ...
        this.referenceDelegate = new Di(this, i), this.Le = n + "main", this.R = new Qr(a), 
        this.Be = new xr(this.Le, 11, new Fi(this.R)), this.Ue = new gi(this.referenceDelegate, this.R), 
 ...
 */
    ...
    /** Returns all local documents matching the specified query. */ t.prototype.getDocumentsMatchingQuery = function(t, e, n, r) {
        ...
        // collection, rather than to perform individual lookups.
            ...
            var s = i.Cn(e, o);
            return (ie(e) || oe(e)) && i.Nn(e.limitType, s, r, n) ? i.Dn(t, e) : (F() <= l.DEBUG && V("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), pe(e)), 
    ...
    t.prototype.Nn = function(t, e, n, r) {
        ...
        return F() <= l.DEBUG && V("QueryEngine", "Using full collection scan to execute query:", pe(e)), 
    ...
    t, e, n, r) {
        ...
        this.Ue = t.getTargetCache(), this.Mn = new Qi(this.Fn, this._n, this.persistence.getIndexManager()), 
...
function Yi(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = Q(t), i = n._n, o = n.Mn, [ 4 /*yield*/ , n.persistence.runTransaction("Handle user change", "readonly", (function(t) {
                    ...
                    return n._n.getAllMutationBatches(t).next((function(s) {
                        ...
                        // MutationQueue.
                        o = new Qi(n.Fn, i, n.persistence.getIndexManager()), i.getAllMutationBatches(t);
                    })).next((function(e) {
 ...
 * queue.
 */ function Ji(t, e) {
    var n = Q(t), r = e.snapshotVersion, i = n.kn;
...
function no(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                n = Q(t), o = n.kn.get(e), s = i ? "readwrite" : "readwrite-primary", r.label = 1;
 ...
 */ function ro(t, e, n) {
    var r = Q(t), i = $.min(), o = pn();
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            var r = Q(t), i = r.$n.get(n);
...
// PORTING NOTE: Multi-Tab only.
function io(t, e) {
    var n = Q(t), r = Q(n.Ue), i = n.kn.get(e);
...
function oo(t) {
    ...
    return e.persistence.runTransaction("Get new document changes", "readonly", (function(t) {
        return function(t, e, n) {
            var r = Q(t), i = an(), o = Wr(n), s = Oi(e), u = IDBKeyRange.lowerBound(o, !0);
            return s.Ot({
 ...
 */ function uo(t, e, i, o) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                for (n = Q(t), s = pn(), u = an(), a = ln(), c = 0, h = i; c < h.length; c++) f = h[c], 
 ...
 */ var co = /** @class */ function() {
    ...
    function t(t, e) {
        ...
        }(this.qt), this.R = new Qr(e), this.Ke = new co(this.R);
    }
    return t.prototype.start = function() {
        return Promise.resolve();
    }, t.prototype.shutdown = function() {
...
var So = /** @class */ function() {
    ...
    t.prototype.js = function(t) {
        ...
        return n(this, void 0, void 0, (function() {
            return r(this, (function(e) {
                return t.user.uid === this.currentUser.uid ? [ 2 /*return*/ , this.syncEngine.ai(t.batchId, t.state, t.error) ] : (V("SharedClientState", "Ignoring mutation for non-active user " + t.user.uid), 
                [ 2 /*return*/ ]);
            }));
        }));
    ...
    return t(n, e), n.prototype.wr = function(t) {
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var c = Fn(t, a.document.name), h = Rn(a.document.updateTime), f = new Rt({
                    mapValue: {
                ...
                y.document;
                var v = Fn(t, y.document), m = y.readTime ? Rn(y.readTime) : $.min(), g = Ot.newNoDocument(v, m), w = y.removedTargetIds || [];
                n = new wn([], w, g.key, g);
            } else if ("documentRemove" in e) {
                e.documentRemove;
                var b = e.documentRemove;
                b.document;
                var I = Fn(t, b.document), T = b.removedTargetIds || [];
                n = new wn([], T, I, null);
            } else {
                        ...
                        [ 4 /*yield*/ , function(t) {
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = Q(t)).Fr.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , Wo(e) ];
...
function us(t) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                e = Q(t), n = vs(e), i = e.$r.length > 0 ? e.$r[e.$r.length - 1].batchId : -1, r.label = 1;
 ...
 */ function ps(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = Q(t), e ? (n.Fr.delete(2 /* IsSecondary */), [ 4 /*yield*/ , zo(n) ]) : [ 3 /*break*/ , 2 ];

              case 1:
                return r.sent(), [ 3 /*break*/ , 5 ];

              case 2:
                return (i = e) ? [ 3 /*break*/ , 4 ] : (n.Fr.add(2 /* IsSecondary */), [ 4 /*yield*/ , Wo(n) ]);
 ...
 */ function Ss(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                if (n = Q(t), i = e.query, o = !1, (s = n.queries.get(i)) || (o = !0, s = new Ts), 
                !o) return [ 3 /*break*/ , 4 ];
                r.label = 1;
 ...
 */ var Os = function(t) {
    ...
    t.prototype.Ro = function() {
        return Is.fromInitialDocuments(this.query, this.fo, this.mutatedKeys, 0 /* Local */ === this.uo);
    }, t;
}(), Ms = function(
/**
     * The query itself.
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(l) {
            switch (l.label) {
              ...
              case 1:
                return s = l.sent(), u = new Fs(e, s.Bn), a = u._o(s.documents), c = gn.createSynthesizedTargetChangeForCurrentChange(i, o && "Offline" /* Offline */ !== t.onlineState), 
                h = u.applyChanges(a, 
                /* updateLimboDocuments= */ t.isPrimaryClient, c), tu(t, i, h.To), f = new Ms(e, i, u), 
...
/** Stops listening to the query. */ function js(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = Q(t), i = n.vo.get(e), (o = n.Vo.get(i.targetId)).length > 1 ? [ 2 /*return*/ , (n.Vo.set(i.targetId, o.filter((function(t) {
                    return !le(t, e);
            ...
            switch (r.label) {
              ...
              case 1:
                return r.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    var n, r = Q(t), i = X.now(), o = e.reduce((function(t, e) {
                        return t.add(e.key);
                    }), pn());
                    return r.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                        return r.Mn.pn(t, o).next((function(o) {
                            ...
                            var s = [], u = 0, a = e; u < a.length; u++) {
                                ...
                                // exists=true
                                s.push(new Qe(c.key, h, Lt(h.value.mapValue), Pe.exists(!0)));
                            }
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                // PORTING NOTE: Multi-tab only.
                return (n = Q(t)).sharedClientState.updateQueryState(e, "rejected", i), o = n.Co.get(e), 
                (s = o && o.key) ? (u = (u = new en(mt.comparator)).insert(s, Ot.newNoDocument(s, $.min())), 
                a = pn().add(s), c = new mn($.min(), 
                /* targetChanges= */ new Map, 
                /* targetMismatches= */ new on(W), u, a), [ 4 /*yield*/ , Qs(n, c) ]) : [ 3 /*break*/ , 2 ];
 ...
 */ function Ys(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                ts((n = Q(t)).remoteStore) || V("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                r.label = 1;
...
function $s(t, e, n) {
    var r = Q(t), i = r.xo[r.currentUser.toKey()];
...
function ru(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(c) {
            switch (c.label) {
              case 0:
                return o = Q(t), s = [], u = [], a = [], o.vo.isEmpty() ? [ 3 /*break*/ , 3 ] : (o.vo.forEach((function(t, n) {
...
function iu(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return (n = Q(t)).currentUser.isEqual(e) ? [ 3 /*break*/ , 3 ] : (V("SyncEngine", "User change. New user:", e.toKey()), 
 ...
 */ function su(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , ro((n = Q(t)).localStore, e.query, 
                /* usePreviousResults= */ !0) ];
...
function uu(t) {
    return n(this, void 0, void 0, (function() {
        var e;
        return r(this, (function(n) {
            return [ 2 /*return*/ , oo((e = Q(t)).localStore).then((function(t) {
                return ru(e, t);
            })) ];
        }));
    }));
...
function cu(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return yu(n = Q(t)), vu(n), !0 !== e || !0 === n.Oo ? [ 3 /*break*/ , 3 ] : (i = n.sharedClientState.getAllActiveQueryTargets(), 
...
function yu(t) {
    var e = Q(t);
    return e.remoteStore.remoteSyncer.applyRemoteEvent = Qs.bind(null, e), e.remoteStore.remoteSyncer.getRemoteKeysForTarget = ou.bind(null, e), 
...
var gu = /** @class */ function() {
    ...
    return t(i, e), i.prototype.initialize = function(t) {
        ...
        return new qi(this.synchronizeTabs, e, t.clientId, n, t.asyncQueue, Fo(), Mo(), this.R, this.sharedClientState, !!this.forceOwnership);
    ...
    return t.prototype.initialize = function(t, e) {
                ...
                switch (r.label) {
                  case 0:
                    ...
                    /* startAsPrimary=*/ !t.synchronizeTabs), this.sharedClientState.onlineStateHandler = function(t) {
                        return Gs(n.syncEngine, t, 1 /* SharedClientState */);
        ...
        return e = this.localStore, n = this.datastore, r = t.asyncQueue, i = function(t) {
            return Gs(s.syncEngine, t, 0 /* RemoteStore */);
        }, o = Ro.gt() ? new Ro : new xo, new Go(e, n, r, i, o);
        ...
        return function(t) {
            return n(this, void 0, void 0, (function() {
                ...
                return r(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        return e = Q(t), V("RemoteStore", "RemoteStore shutting down."), e.Fr.add(5 /* Shutdown */), 
                        [ 4 /*yield*/ , Wo(e) ];
                    ...
                    return [ 4 /*yield*/ , function(t, e) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    return n = Q(t), i = qn(n.R) + "/documents", o = {
                                    ...
                                    return s = r.sent(), u = new Map, s.forEach((function(t) {
                                        var e = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = Fn(t, e.found.name), r = Rn(e.found.updateTime), i = new Rt({
                                                    mapValue: {
                    ...
                    return function(t, e) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    return (n = Q(t)).asyncQueue.verifyOperationInProgress(), V("RemoteStore", "RemoteStore received new credentials"), 
                                    i = ts(n), 
...
/** Enables the network connection and re-enqueues all pending operations. */ function Mu(t, e, i) {
    var o = this;
    void 0 === i && (i = {});
    var s = new Ar;
...
function(t, e, n, r, i, o, s, u) {
    ...
    function t(t) {
        ...
        var n = function(t) {
            V("FirebaseCredentialsProvider", "Auth detected"), e.auth = t, e.lc(), e.auth.addAuthTokenListener(e.uc);
        };
        t.onInit((function(t) {
            return n(t);
        })), 
        ...
        setTimeout((function() {
            if (!e.auth) {
                ...
                // with null token
                V("FirebaseCredentialsProvider", "Auth not yet detected"), e.asyncQueue.enqueueRetryable((function() {
                    return e.changeListener(e.currentUser);
                })));
            }
        }), 0);
    ...
    function t(t, e, n) {
        this.fc = t, this.dc = e, this.wc = n, this.type = "FirstParty", this.user = bo.FIRST_PARTY;
    }
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new zu(this.fc, this.dc, this.wc));
    }, t.prototype.setChangeListener = function(t, e) {
 ...
 */ function na(t, e, n, r) {
    ...
    t._setSettings(Object.assign(Object.assign({}, i), {
        ...
        t._credentials = new Qu(new ju(o, new bo(s)));
    }
}
    ...
    t.prototype.bc = function() {
        ...
        var e = this, n = this._c.then((function() {
            return e.Tc = !0, t().catch((function(t) {
                ...
                throw e.Ec = t, e.Tc = !1, q("INTERNAL UNHANDLED ERROR: ", 
                /**
                        ...
                        return i = o.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!1), function(t) {
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = Q(t)).Fr.add(0 /* UserDisabled */), [ 4 /*yield*/ , Wo(e) ];
...
}(), Fa = /^__.*__$/, Ma = /** @class */ function() {
    function t(t, e, n) {
        this.data = t, this.fieldMask = e, this.fieldTransforms = n;
    }
    return t.prototype.toMutation = function(t, e) {
        return null !== this.fieldMask ? new Qe(t, this.data, this.fieldMask, e, this.fieldTransforms) : new Ke(t, this.data, e, this.fieldTransforms);
    }, t;
}(), Va = /** @class */ function() {
    function t(t, 
...
/** A "context" object passed around while parsing user data. */ var Ua = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.kc = function(e) {
        ...
        return sc(t, this.settings.methodName, this.settings.Uc || !1, this.path, this.settings.qc);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (qa(this.xc) && Fa.test(t)) throw this.Bc('Document fields cannot begin and end with "__"');
    }, t;
}(), Ba = /** @class */ function() {
    function t(t, e, n) {
...
var za = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = new Ce(t.R, be(t.R, this.jc));
...
/** Parse update data from a list of field/value arguments. */ function $a(t, e, n, r, i, o) {
    var s = t.Kc(1 /* Update */ , e, n), u = [ rc(e, r, n) ], a = [ i ];
 ...
 */ function Ja(t, e, n, r) {
    return void 0 === r && (r = !1), Za(n, t.Kc(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Za(t, e) {
    ...
    return function(t, e) {
        ...
        if (!qa(e.xc)) throw e.Bc(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        throw e.Bc("Unsupported field value: " + $u(t));
    }(t, e);
}
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((function(e) {
                    var r = new dc(t._firestore, t._userDataWriter, e.doc.key, e.doc, new fc(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter);
                    return e.doc, {
                        type: "added",
                        doc: r,
                        oldIndex: -1,
...
var Sc = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        return new ia(t.firestore, t.converter, fe(t._query, this.Jc, this.Yc));
    }, n;
}(gc);
...
var Dc = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        var e = Lc(t, this.type, this.Xc, this.Zc);
        return new ia(t.firestore, t.converter, function(t, e) {
 ...
 */ function jc(t) {
    ...
    return Mu(ga(e), t._key).then((function(n) {
        return nh(e, t, n);
    }));
}
                            ...
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(r) {
                                    switch (r.label) {
                                      ...
                                      case 1:
                                        return n = r.sent(), o = new Fs(e, n.Bn), s = o._o(n.documents), u = o.applyChanges(s, 
