...
class ou {
    constructor(t) {
        ...
        const e = t => {
            $("FirebaseCredentialsProvider", "Auth detected"), this.auth = t, this.lc(), this.auth.addAuthTokenListener(this.ac);
        };
        t.onInit((t => e(t))), 
        ...
        setTimeout((() => {
            if (!this.auth) {
                ...
                // with null token
                $("FirebaseCredentialsProvider", "Auth not yet detected"), this.asyncQueue.enqueueRetryable((() => this.changeListener(this.currentUser))));
            }
        }), 0);
    }
    getToken() {
 ...
 */ class uu {
    ...
    getToken() {
        return Promise.resolve(new cu(this.fc, this.dc, this.wc));
    }
    setChangeListener(t, e) {
 ...
 */ (t)), t;
    ...
    enqueueAfterDelay(t, e, n) {
        ...
        const s = Ro.createAndSchedule(this, t, e, n, (t => this.vc(t)));
...
/** A "context" object passed around while parsing user data. */ class ea {
    ...
    Bc(t) {
        return Ta(t, this.settings.methodName, this.settings.Uc || !1, this.path, this.settings.qc);
    }
    ...
    Fc(t) {
        ...
        if (ta(this.xc) && Yu.test(t)) throw this.Bc('Document fields cannot begin and end with "__"');
    }
}
...
class ha extends Hu {
    ...
    _toFieldTransform(t) {
        const e = new De(t.R, Ee(t.R, this.jc));
...
/** Parse update data from a list of field/value arguments. */ function fa(t, e, n, s, i, r) {
    const o = t.Kc(1 /* Update */ , e, n), c = [ ya(e, s, n) ], u = [ i ];
 ...
 */ function da(t, e, n, s = !1) {
    return wa(n, t.Kc(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */
    return function(t, e) {
        ...
        if (!ta(e.xc)) throw e.Bc(`${t._methodName}() can only be used with update() and set()`);
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        throw e.Bc(`Unsupported field value: ${fu(t)}`);
    }
    /**
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((s => {
                    const i = new Va(t._firestore, t._userDataWriter, s.doc.key, s.doc, new ba(t._snapshot.mutatedKeys.has(s.doc.key), t._snapshot.fromCache), t.query.converter);
                    return e = s.doc, {
                        type: "added",
                        doc: i,
                        oldIndex: -1,
...
class La extends xa {
    ...
    _apply(t) {
        return new pu(t.firestore, t.converter, le(t._query, this.Jc, this.Yc));
    }
}
...
class qa extends xa {
    ...
    _apply(t) {
        const e = za(t, this.type, this.Xc, this.Zc);
        return new pu(t.firestore, t.converter, function(t, e) {
...
}), "PUBLIC" /* PUBLIC */)), i("@firebase/firestore", "2.3.4", bh);
