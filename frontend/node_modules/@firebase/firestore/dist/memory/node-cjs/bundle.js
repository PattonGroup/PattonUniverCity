...
function loadBundle(data) {
    return database52b6fbff.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    return database52b6fbff.namedQuery(this._delegate, queryName).then(expQuery => {
        if (!expQuery) {
            return null;
        }
        return new database52b6fbff.Query$1(this, 
...
registerBundle(database52b6fbff.Firestore);
