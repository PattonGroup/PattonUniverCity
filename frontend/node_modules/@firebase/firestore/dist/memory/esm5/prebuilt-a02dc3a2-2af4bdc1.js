...
import { XhrIo as h, EventType as l, ErrorCode as f, createWebChannelTransport as d, getStatEventTarget as p, FetchXmlHttpFactory as y, WebChannel as v, Event as m, Stat as g } from "@firebase/webchannel-wrapper";

import { __extends as w, __awaiter as b, __generator as _, __spreadArray as E } from "tslib";
...
var I = {
    ...
    return w(e, t), e;
}(Error), N = new a("@firebase/firestore");
 ...
 */ function D(t) {
    ...
    if (N.logLevel <= c.DEBUG) {
        var r = e.map(C);
        N.debug.apply(N, E([ "Firestore (8.6.5): " + t ], r));
    }
}
...
function k(t) {
    ...
    if (N.logLevel <= c.ERROR) {
        var r = e.map(C);
        N.error.apply(N, E([ "Firestore (8.6.5): " + t ], r));
    }
}
...
function R(t) {
    ...
    if (N.logLevel <= c.WARN) {
        var r = e.map(C);
        N.warn.apply(N, E([ "Firestore (8.6.5): " + t ], r));
    }
}
...
}(K), W = /^[_a-zA-Z][_a-zA-Z0-9]*$/, z = /** @class */ function(t) {
    function e() {
        return null !== t && t.apply(this, arguments) || this;
    }
    return w(e, t), e.prototype.construct = function(t, n, r) {
...
var Dt = /** @class */ function(t) {
     ...
     */    return w(e, t), e.create = function(t, n, r) {
        return t.isKeyField() ? "in" /* IN */ === n || "not-in" /* NOT_IN */ === n ? this.l(t, n, r) : new kt(t, n, r) : "array-contains" /* ARRAY_CONTAINS */ === n ? new Ot(t, r) : "in" /* IN */ === n ? new Pt(t, r) : "not-in" /* NOT_IN */ === n ? new Ft(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === n ? new Vt(t, r) : new e(t, n, r);
    }, e.l = function(t, e, n) {
...
var kt = /** @class */ function(t) {
    function e(e, n, r) {
        var i = this;
        return (i = t.call(this, e, n, r) || this).key = ot.fromName(r.referenceValue), 
        i;
    }
...
}(Dt), Rt = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
        return (r = t.call(this, e, "in" /* IN */ , n) || this).keys = Lt("in" /* IN */ , n), 
        r;
    }
    return w(e, t), e.prototype.matches = function(t) {
...
}(Dt), Ct = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
        return (r = t.call(this, e, "not-in" /* NOT_IN */ , n) || this).keys = Lt("not-in" /* NOT_IN */ , n), 
        r;
    }
    return w(e, t), e.prototype.matches = function(t) {
        return !this.keys.some((function(e) {
 ...
 */ function Xt(t) {
    ...
    if (null === e.p) {
        ...
        n.isKeyField() || e.p.push(new xt(n)), e.p.push(new xt(z.keyField(), "asc" /* ASCENDING */)); else {
...
/** Transforms a value into a server-generated timestamp. */ var fe = /** @class */ function(t) {
    function e() {
        return null !== t && t.apply(this, arguments) || this;
    }
    return w(e, t), e;
}(ae), de = /** @class */ function(t) {
    function e(e) {
        var n = this;
...
/** Transforms an array value via a remove operation. */ var ye = /** @class */ function(t) {
    function e(e) {
        var n = this;
        return (n = t.call(this) || this).elements = e, n;
    }
...
/** A mutation that deletes the document at the given key. */ var Fe, Ve, Me = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
 ...
 */
    ...
    /** Returns all local documents matching the specified query. */ t.prototype.getDocumentsMatchingQuery = function(t, e, n, r) {
        ...
        // collection, rather than to perform individual lookups.
            ...
            var s = i.Cn(e, o);
            return (Qt(e) || Wt(e)) && i.Nn(e.limitType, s, r, n) ? i.Dn(t, e) : (S() <= c.DEBUG && D("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), ee(e)), 
    ...
    t.prototype.Nn = function(t, e, n, r) {
        ...
        return S() <= c.DEBUG && D("QueryEngine", "Using full collection scan to execute query:", ee(e)), 
              ...
              case 0:
                return n = P(t), r = n._n, i = n.Mn, [ 4 /*yield*/ , n.persistence.runTransaction("Handle user change", "readonly", (function(t) {
                    ...
                    return n._n.getAllMutationBatches(t).next((function(s) {
                        ...
                        // MutationQueue.
                        i = new or(n.On, r, n.persistence.getIndexManager()), r.getAllMutationBatches(t);
                    })).next((function(e) {
                        for (var n = [], r = [], s = tn(), u = 0, a = o
 ...
 */ function gr(t, e, n, r) {
    return b(this, void 0, void 0, (function() {
        ...
        return _(this, (function(p) {
            switch (p.label) {
              case 0:
                for (i = P(t), o = tn(), s = He(), u = Ze(), a = 0, c = n; a < c.length; a++) h = c[a], 
                l = e.qn(h.metadata.name), h.document && (o = o.add(l)), s = s.insert(l, e.Un(h)), 
                u = u.insert(l, e.Qn(h.metadata.readTime));
                return f = i.On.newChangeBuffer({
                    trackRemovals: !0
                }), [ 4 /*yield*/ , yr(i, function(t) {
              ...
              case 1:
                ...
                return d = p.sent(), [ 2 /*return*/ , i.persistence.runTransaction("Apply bundle documents", "readwrite", (function(t) {
                    return dr(t, f, s, q.min(), u).next((function(e) {
                        return f.apply(t), e;
                    })).next((function(e) {
 ...
 */ function wr(t, e, n) {
    return void 0 === n && (n = tn()), b(this, void 0, void 0, (function() {
        var r, i;
        return _(this, (function(o) {
            switch (o.label) {
              case 0:
                return [ 4 /*yield*/ , yr(t, Jt(Jn(e.bundledQuery))) ];
 ...
 */ var br = /** @class */ function() {
    ...
    return t.prototype.getBundleMetadata = function(t, e) {
        return Qn.resolve(this.Kn.get(e));
    ...
    function t(t, e) {
        ...
        }(this.Ut), this.R = new Xn(e), this.Qe = new br(this.R);
    }
...
var Cr = /** @class */ function() {
    ...
    function u(t) {
        ...
        e.useFetchStreams = t.useFetchStreams, e;
    }
    /**
     * Base class for all Rest-based connections to the backend (WebChannel and
     * HTTP).
     */
    return w(u, s), u.prototype.ki = function(t, e, n, r) {
        ...
        this.useFetchStreams && (l.xmlHttpFactory = new y({})), this.Fi(l.initMessageHeaders, u), 
        ...
        var w = c.createWebChannel(f, l), b = !1, _ = !1, E = new Vr({
            Ei: function(t) {
                _ ? D("Connection", "Not sending because WebChannel is closed:", t) : (b || (D("Connection", "Opening WebChannel transport."), 
                w.open(), b = !0), D("Connection", "WebChannel sending:", t), w.send(t));
            },
            Ti: function() {
                return w.close();
            }
        ...
        return T(w, v.EventType.OPEN, (function() {
            _ || D("Connection", "WebChannel transport opened.");
        })), T(w, v.EventType.CLOSE, (function() {
            _ || (_ = !0, D("Connection", "WebChannel transport closed"), E.Vi());
        })), T(w, v.EventType.ERROR, (function(t) {
            _ || (_ = !0, R("Connection", "WebChannel transport errored:", t), E.Vi(new A(I.UNAVAILABLE, "The operation could not be completed")));
        })), T(w, v.EventType.MESSAGE, (function(t) {
            var e;
            if (!_) {
                var n = t.data[0];
                O(!!n);
 ...
 */
                    ...
                    _ = !0, E.Vi(new A(s, u)), w.close();
                } else D("Connection", "WebChannel received:", n), E.Si(n);
            }
        })), T(h, m.STAT_EVENT, (function(t) {
            t.stat === g.PROXY ? D("Connection", "Detected buffering proxy") : t.stat === g.NOPROXY && D("Connection", "Detected no buffering proxy");
        })), setTimeout((function() {
            ...
            return _(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    this.Zi.Ki()) : e && e.code === I.UNAUTHENTICATED && 
...
function oi(t, e, n) {
    return b(this, void 0, void 0, (function() {
        ...
        return _(this, (function(s) {
            switch (s.label) {
              case 0:
                if (t.Br.set("Online" /* Online */), !(e instanceof an && 2 /* Removed */ === e.state && e.cause)) 
              ...
              case 6:
                if (e instanceof sn ? t.qr.X(e) : e instanceof un ? t.qr.rt(e) : t.qr.et(e), n.isEqual(q.min())) return [ 3 /*break*/ , 13 ];
                s.label = 7;

              case 7:
                return s.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , lr(t.localStore) ];
              ...
              case 11:
                return D("RemoteStore", "Failed to raise snapshot:", o = s.sent()), [ 4 /*yield*/ , si(t, o) ];
                    ...
                    return b(r, void 0, void 0, (function() {
                        return _(this, (function(e) {
                            switch (e.label) {
                              ...
                              case 1:
                                return e.sent(), t.Or.delete(1 /* IndexedDbFailed */), [ 4 /*yield*/ , zr(t) ];
...
function ai(t) {
    return b(this, void 0, void 0, (function() {
        ...
        return _(this, (function(s) {
            switch (s.label) {
              case 0:
                e = P(t), n = mi(e), r = e.kr.length > 0 ? e.kr[e.kr.length - 1].batchId : -1, s.label = 1;
 ...
 */ (e)) return [ 3 /*break*/ , 7 ];
              ...
              case 2:
                return s.trys.push([ 2, 4, , 6 ]), [ 4 /*yield*/ , pr(e.localStore, r) ];
              ...
              case 4:
                return o = s.sent(), [ 4 /*yield*/ , si(e, o) ];
...
function fi(t) {
    return b(this, void 0, void 0, (function() {
        ...
        return _(this, (function(o) {
            ...
            for (e = mi(t), n = 0, r = t.kr; n < r.length; n++) i = r[n], e.Er(i.mutations);
            return [ 2 /*return*/ ];
        }));
    }));
}
...
function di(t, e, n) {
    return b(this, void 0, void 0, (function() {
        ...
        return _(this, (function(o) {
            switch (o.label) {
              case 0:
                return r = t.kr.shift(), i = Hn.from(r, e, n), [ 4 /*yield*/ , ui(t, (function() {
...
function pi(t, e) {
    return b(this, void 0, void 0, (function() {
        return _(this, (function(n) {
            switch (n.label) {
              case 0:
                return e && mi(t).pr ? [ 4 /*yield*/ , function(t, e) {
                    return b(this, void 0, void 0, (function() {
                        var n, r;
                        return _(this, (function(i) {
                            switch (i.label) {
                              case 0:
                                return qe(r = e.code) && r !== I.ABORTED ? (n = t.kr.shift(), 
 ...
 */ function yi(t, e) {
    return b(this, void 0, void 0, (function() {
        ...
        return _(this, (function(i) {
            switch (i.label) {
              case 0:
                return n = P(t), e ? (n.Or.delete(2 /* IsSecondary */), [ 4 /*yield*/ , zr(n) ]) : [ 3 /*break*/ , 2 ];

              case 1:
                return i.sent(), [ 3 /*break*/ , 5 ];

              case 2:
                return (r = e) ? [ 3 /*break*/ , 4 ] : (n.Or.add(2 /* IsSecondary */), [ 4 /*yield*/ , Hr(n) ]);
    ...
    t.Ur = function(t, e, n) {
        ...
        return b(e, void 0, void 0, (function() {
            return _(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return n ? (t.Ur.sr(), ti(t) ? $r(t) : t.Br.set("Unknown" /* Unknown */), [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 1 ];
    ...
    t.Qr = function(t, e, n) {
        ...
        return b(e, void 0, void 0, (function() {
            return _(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return n ? (t.Qr.sr(), [ 4 /*yield*/ , ai(t) ]) : [ 3 /*break*/ , 2 ];
 ...
 */ function wi(t, e) {
    if (k("AsyncQueue", e + ": " + t), Wn(t)) return new A(I.UNAVAILABLE, e + ": " + t);
    throw t;
}
 ...
 */ function Ai(t, e) {
    return b(this, void 0, void 0, (function() {
        ...
        return _(this, (function(c) {
            switch (c.label) {
              case 0:
                if (n = P(t), r = e.query, i = !1, (o = n.queries.get(r)) || (i = !0, o = new Ti), 
                !i) return [ 3 /*break*/ , 4 ];
                c.label = 1;
              ...
              case 3:
                return u = c.sent(), a = wi(u, "Initialization of query '" + ee(e.query) + "' failed"), 
                [ 2 /*return*/ , void e.onError(a) ];

              case 4:
                return n.queries.set(r, o), o.listeners.push(e), 
                // Run global snapshot listeners if a consistent snapshot has been emitted.
                e.zr(n.onlineState), o.Wr && e.Hr(o.Wr) && ki(n), [ 2 /*return*/ ];
            }
        }));
    }));
}
        ...
        return b(this, void 0, void 0, (function() {
            ...
            return _(this, (function(o) {
                switch (o.label) {
                  ...
                  case 2:
                    return n < r.length ? (i = r[n], [ 4 /*yield*/ , wr(this.localStore, i, e.get(i.name)) ]) : [ 3 /*break*/ , 5 ];
 ...
 */ var Fi = function(t) {
    ...
    t.prototype._o = function(t, e) {
        var n = this, r = e ? e.mo : new _i, i = e ? e.fo : this.fo, o = e ? e.mutatedKeys : this.mutatedKeys, s = i, u = !1, a = Qt(this.query) && i.size === this.query.limit ? i.last() : null, c = Wt(this.query) && i.size === this.query.limit ? i.first() : null;
            ...
            switch (a.label) {
              case 0:
                return n = function(t) {
                    ...
                    e.remoteStore.remoteSyncer.rejectListen = zi.bind(null, e), e.vo._r = Si.bind(null, e.eventManager), 
              ...
              case 1:
                return [ 4 /*yield*/ , yr(n.localStore, Jt(e)) ];

              case 2:
                return s = a.sent(), u = n.sharedClientState.addLocalQueryTarget(s.targetId), r = s.targetId, 
                [ 4 /*yield*/ , ji(n, e, r, "current" === u) ];

              case 3:
                i = a.sent(), n.isPrimaryClient && Yr(n.remoteStore, s), a.label = 4;
                    ...
                    return function(t, e, n, r) {
                        return b(this, void 0, void 0, (function() {
                            ...
                            return _(this, (function(u) {
                                switch (u.label) {
                                  case 0:
                                    return i = e.view._o(n), i.Nn ? [ 4 /*yield*/ , mr(t.localStore, e.query, 
                                  ...
                                  case 2:
                                    ...
                                    /* updateLimboDocuments= */ t.isPrimaryClient, o), [ 2 /*return*/ , (eo(t, e.targetId, s.To), 
                                    s.snapshot) ];
                                }
                            }));
                        }));
                    }(t, e, n, r);
                }, [ 4 /*yield*/ , mr(t.localStore, e, 
                /* usePreviousResults= */ !0) ];

              case 1:
                return i = h.sent(), o = new Mi(e, i.Bn), s = o._o(i.documents), u = on.createSynthesizedTargetChangeForCurrentChange(n, r && "Offline" /* Offline */ !== t.onlineState), 
                a = o.applyChanges(s, 
                /* updateLimboDocuments= */ t.isPrimaryClient, u), eo(t, n, a.To), c = new Ui(e, n, o), 
...
/** Stops listening to the query. */ function Gi(t, e) {
    return b(this, void 0, void 0, (function() {
        var n, r, i;
        return _(this, (function(o) {
            switch (o.label) {
              case 0:
                ...
                n.sharedClientState.removeLocalQueryTarget(r.targetId), n.sharedClientState.isActiveQueryTarget(r.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , vr(n.localStore, r.targetId, 
                /*keepPersistedTargetData=*/ !1).then((function() {
                    n.sharedClientState.clearQueryState(r.targetId), Xr(n.remoteStore, r.targetId), 
                    $i(n, r.targetId);
                })).catch(er) ]) : [ 3 /*break*/ , 3 ];
              ...
              case 3:
                return $i(n, r.targetId), [ 4 /*yield*/ , vr(n.localStore, r.targetId, 
 ...
 */;
              ...
              case 2:
                ...
                }(r, i.batchId, n), [ 4 /*yield*/ , io(r, i.changes) ];

              case 3:
                return u.sent(), [ 4 /*yield*/ , ai(r.remoteStore) ];

              case 4:
                return u.sent(), [ 3 /*break*/ , 6 ];

              case 5:
                return o = u.sent(), s = wi(o, "Failed to persist write"), n.reject(s), [ 3 /*break*/ , 6 ];
    ...
    return b(this, void 0, void 0, (function() {
        ...
        return _(this, (function(i) {
            switch (i.label) {
              ...
              case 1:
                return i.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , fr(n.localStore, e) ];
        ...
        return _(this, (function(c) {
            switch (c.label) {
              case 0:
                ...
                (o = i && i.key) ? (s = (s = new je(ot.comparator)).insert(o, Et.newNoDocument(o, q.min())), 
                u = tn().add(o), a = new rn(q.min(), 
                /* targetChanges= */ new Map, 
                /* targetMismatches= */ new Qe(M), s, u), [ 4 /*yield*/ , Qi(r, a) ]) : [ 3 /*break*/ , 2 ];
              ...
              case 1:
                ...
                r.Do = r.Do.remove(o), r.Co.delete(e), ro(r), [ 3 /*break*/ , 4 ];

              case 2:
                return [ 4 /*yield*/ , vr(r.localStore, e, 
                /* keepPersistedTargetData */ !1).then((function() {
                    return $i(r, e, n);
                })).catch(er) ];
    ...
    return b(this, void 0, void 0, (function() {
        ...
        return _(this, (function(o) {
            switch (o.label) {
              ...
              case 1:
                return o.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , hr(n.localStore, e) ];
              ...
              case 2:
                ...
                Zi(n, r, /*error=*/ null), Ji(n, r), n.sharedClientState.updateMutationState(r, "acknowledged"), 
                [ 4 /*yield*/ , io(n, i) ];
        ...
        return _(this, (function(o) {
            switch (o.label) {
              ...
              case 2:
                ...
                // listen events.
                Zi(r, e, n), Ji(r, e), r.sharedClientState.updateMutationState(e, "rejected", n), 
                [ 4 /*yield*/ , io(r, i) ];
 ...
 */ function Xi(t, e) {
    return b(this, void 0, void 0, (function() {
        ...
        return _(this, (function(u) {
            switch (u.label) {
              case 0:
                ei((n = P(t)).remoteStore) || D("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                u.label = 1;
              ...
              case 3:
                return o = u.sent(), s = wi(o, "Initialization of waitForPendingWrites() operation failed"), 
                              ...
                              case 1:
                                return l.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(t) {
                                    return Qn.forEach(e, (function(e) {
                                        return Qn.forEach(e.bn, (function(r) {
                                            return n.persistence.referenceDelegate.addReference(t, e.targetId, r);
                                        })).next((function() {
                                            return Qn.forEach(e.vn, (function(r) {
...
function oo(t, e) {
    return b(this, void 0, void 0, (function() {
        ...
        return _(this, (function(i) {
            switch (i.label) {
              case 0:
                return (n = P(t)).currentUser.isEqual(e) ? [ 3 /*break*/ , 3 ] : (D("SyncEngine", "User change. New user:", e.toKey()), 
                [ 4 /*yield*/ , cr(n.localStore, e) ]);
              ...
              case 1:
                ...
                n.sharedClientState.handleUserChange(e, r.removedBatchIds, r.addedBatchIds), [ 4 /*yield*/ , io(n, r.Ln) ];
        ...
        return b(this, void 0, void 0, (function() {
            ...
            return _(this, (function(c) {
                switch (c.label) {
                  ...
                  case 4:
                    return n._updateProgress(Pi(r)), i = new Oi(r, t.localStore, e.R), [ 4 /*yield*/ , e.Lo() ];
                  ...
                  case 11:
                    ...
                    // has newer version.
                    return u = c.sent(), [ 4 /*yield*/ , io(t, u.wn, 
                    /* remoteEvent */ void 0) ];
                  ...
                  case 14:
                    return R("SyncEngine", "Loading bundle failed with " + (a = c.sent())), n._failWith(a), 
                    [ 3 /*break*/ , 15 ];
...
var ao = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t, e) {
                ...
                switch (r.label) {
                  case 0:
                    ...
                    /* startAsPrimary=*/ !t.synchronizeTabs), this.sharedClientState.onlineStateHandler = function(t) {
                        return Wi(n.syncEngine, t, 1 /* SharedClientState */);
        ...
        return e = this.localStore, n = this.datastore, r = t.asyncQueue, i = function(t) {
            return Wi(s.syncEngine, t, 0 /* RemoteStore */);
        }, o = Pr.yt() ? new Pr : new Or, new Wr(e, n, r, i, o);
        ...
        return b(this, void 0, void 0, (function() {
            ...
            return _(this, (function(i) {
                switch (i.label) {
                  ...
                  case 2:
                    return r = i.sent(), [ 2 /*return*/ , new Ci(JSON.parse(r), t.length + n) ];
                }
            }));
        }));
    }, 
            ...
            return b(t, void 0, void 0, (function() {
                ...
                return _(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 5:
                        return t = r.sent(), n = wi(t, "Failed to shutdown persistence"), e.reject(n), [ 3 /*break*/ , 6 ];
                ...
                return o.sent(), r = n.initialUser, t.setCredentialChangeListener((function(t) {
                    return b(i, void 0, void 0, (function() {
                        return _(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return r.isEqual(t) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , cr(e.localStore, t) ];
                    ...
                    return function(t, e) {
                        return b(this, void 0, void 0, (function() {
                            ...
                            return _(this, (function(i) {
                                switch (i.label) {
                                  case 0:
                                    return (n = P(t)).asyncQueue.verifyOperationInProgress(), D("RemoteStore", "RemoteStore received new credentials"), 
                                    r = ei(n), 
                                    // Tear down and re-create our network streams. This will ensure we get a
                                    // fresh auth token for the new user and re-fill the write pipeline with
                                    // new mutations from the LocalStore (since mutations are per-user).
                                    n.Or.add(3 /* CredentialChange */), [ 4 /*yield*/ , Hr(n) ];
                                  ...
                                  case 2:
                                    return i.sent(), n.Or.delete(3 /* CredentialChange */), [ 4 /*yield*/ , zr(n) ];
    ...
    return b(this, void 0, void 0, (function() {
        ...
        return _(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return e = r.sent(), [ 2 /*return*/ , ((n = e.eventManager).onListen = Bi.bind(null, e.syncEngine), 
                n.onUnlisten = Gi.bind(null, e.syncEngine), n) ];
            }
        }));
    }));
}

/** Enables the network connection and re-enqueues all pending operations. */ function No(t, e, n) {
    var r = this;
    void 0 === n && (n = {});
    var i = new Kn;
...
function(t, e, n, r, i, o, s, u) {
    ...
    function t(t) {
        ...
        var n = function(t) {
            D("FirebaseCredentialsProvider", "Auth detected"), e.auth = t, e.lc(), e.auth.addAuthTokenListener(e.ac);
        };
        t.onInit((function(t) {
            return n(t);
        })), 
        ...
        setTimeout((function() {
            if (!e.auth) {
                ...
                // with null token
                D("FirebaseCredentialsProvider", "Auth not yet detected"), e.asyncQueue.enqueueRetryable((function() {
                    return e.changeListener(e.currentUser);
                })));
            }
        }), 0);
    ...
    function t(t, e, n) {
        this.fc = t, this.dc = e, this.wc = n, this.type = "FirstParty", this.user = Rr.FIRST_PARTY;
    }
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new Fo(this.fc, this.dc, this.wc));
    }, t.prototype.setChangeListener = function(t, e) {
 ...
 */
    ...
    function e(e, n, r) {
        var i = this;
        return (i = t.call(this, e, n, Kt(r)) || this)._path = r, 
        /** The type of this Firestore reference. */
        i.type = "collection", i;
    }
    return w(e, t), Object.defineProperty(e.prototype, "id", {
        ...
        get: function() {
            ...
            return t.isEmpty() ? null : new zo(this.firestore, 
 ...
 */ function Xo(t, e) {
    ...
    if (t = s(t), Mo("collection", "path", e), t instanceof Wo) return Bo(n = Q.fromString.apply(Q, E([ e ], r))), 
    new Yo(t, /* converter= */ null, n);
    if (!(t instanceof zo || t instanceof Yo)) throw new A(I.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    return Bo(n = Q.fromString.apply(Q, E([ t.path ], r)).child(Q.fromString(e))), new Yo(t.firestore, 
    /* converter= */ null, n);
}
 ...
 */ function Jo(t, e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = V.u()), Mo("doc", "path", e), t instanceof Wo) return qo(n = Q.fromString.apply(Q, E([ e ], r))), 
    new zo(t, 
    /* converter= */ null, new ot(n));
    if (!(t instanceof zo || t instanceof Yo)) throw new A(I.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    return qo(n = t._path.child(Q.fromString.apply(Q, E([ e ], r)))), new zo(t.firestore, t instanceof Yo ? t.converter : null, new ot(n));
}
 ...
 * Firestore database.
 */ function Zo(t, e) {
    return t = s(t), e = s(e), (t instanceof zo || t instanceof Yo) && (e instanceof zo || e instanceof Yo) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter
    /**
...
function $o(t, e) {
    return t = s(t), e = s(e), t instanceof Ho && e instanceof Ho && t.firestore === e.firestore && $t(t._query, e._query) && t.converter === e.converter
    /**
 * @license
 * Copyright 2020 Google LLC
 *
...
}(), rs = -1, is = /** @class */ function(t) {
    /** @hideconstructor */
    function e(e, n) {
        var r = this;
        return (r = t.call(this, e, n) || this).type = "firestore", r._queue = new ts, r._persistenceKey = "name" in e ? e.name : "[DEFAULT]", 
        r;
    }
...
/** A "context" object passed around while parsing user data. */ var ys = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Fc = function(e) {
        ...
        return Fs(t, this.settings.methodName, this.settings.qc || !1, this.path, this.settings.Uc);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (ps(this.xc) && ls.test(t)) throw this.Bc('Document fields cannot begin and end with "__"');
    }, t;
}(), vs = /** @class */ function() {
    function t(t, e, n) {
...
}(cs), Is = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
        return (r = t.call(this, e) || this).jc = n, r;
    }
    return w(e, t), e.prototype._toFieldTransform = function(t) {
        var e = new me(t.R, ue(t.R, this.jc));
...
/** Parse update data from a list of field/value arguments. */ function Ns(t, e, n, r, i, o) {
    ...
    for (var h = 0; h < o.length; h += 2) a.push(Ls(e, o[h])), c.push(o[h + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var l = [], f = bt.empty(), d = a.length - 1; d >= 0; --d) if (!Vs(l, a[d])) {
        var p = a[d], y = c[d];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        y = s(y);
    ...
    var g = new H(l);
    return new ds(f, g, u.fieldTransforms);
}
 ...
 */ function Ds(t, e) {
    ...
    // from firestore-exp.
    t = s(t))) return Cs("Unsupported field value:", e, t), ks(t, e);
    if (t instanceof cs) 
    ...
    return function(t, e) {
        ...
        if (!ps(e.xc)) throw e.Bc(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        throw e.Bc("Unsupported field value: " + jo(t));
    }(t, e);
}
...
function Rs(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof x || t instanceof hs || t instanceof as || t instanceof zo || t instanceof cs);
}
 ...
 */ function Ls(t, e, n) {
    ...
    // FieldPath.
    (e = s(e)) instanceof us) return e._internalPath;
 ...
 */ function Ps(t, e, n) {
    ...
    /* path= */ void 0, n);
    try {
        return (new (us.bind.apply(us, E([ void 0 ], e.split(".")))))._internalPath;
    } catch (r) {
 ...
 */ var Ms = /** @class */ function() {
    ...
    return Object.defineProperty(t.prototype, "id", {
         ...
         */
        get: function() {
            return new zo(this._firestore, this._converter, this._key);
        },
        enumerable: !1,
        configurable: !0
    }), 
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((function(e) {
                    var r = new js(t._firestore, t._userDataWriter, e.doc.key, e.doc, new qs(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter);
                    return e.doc, {
                        type: "added",
                        doc: r,
                        oldIndex: -1,
 ...
 * limitations under the License.
 */ function Ws(t) {
    if (Wt(t) && 0 === t.explicitOrderBy.length) throw new A(I.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
function eu(t, e, n) {
    ...
    if (n instanceof zo) return dt(t, n._key);
...
var su = /** @class */ function(t) {
    ...
    return w(e, t), e.prototype.convertBytes = function(t) {
        ...
        return new zo(this.firestore, /* converter= */ null, e);
    }, e;
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        this._verifyNotCommitted();
        var o, u = au(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = s(e)) || e instanceof us ? Ns(this._dataReader, "WriteBatch.update", u._key, e, n, r) : As(this._dataReader, "WriteBatch.update", u._key, e), 
        this._mutations.push(o.toMutation(u._key, Ee.exists(!0))), this;
    }, 
    /**
 ...
 * called.
 */ function au(t, e) {
    if ((t = s(t)).firestore !== e) throw new A(I.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
 ...
 */ function hu(t, e, n) {
    for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
    t = Go(t, zo);
    var o = Go(t.firestore, is), u = ms(o);
    return fu(o, [ ("string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = s(e)) || e instanceof us ? Ns(u, "updateDoc", t._key, e, n, r) : As(u, "updateDoc", t._key, e)).toMutation(t._key, Ee.exists(!0)) ]);
}
 ...
 */ function lu(t) {
    ...
    "object" != typeof i[a] || es(i[a]) || (u = i[a], a++);
    var c, h, l, f = {
    ...
    if (t instanceof zo) h = Go(t.firestore, is), l = Kt(t._key.path), c = {
        next: function(e) {
            i[a] && i[a](du(h, t, e));
        },
        error: i[a + 1],
        ...
        var p = Go(t, Ho);
        h = Go(p.firestore, is), l = p._query;
        var y = new cu(h);
        c = {
            next: function(t) {
                i[a] && i[a](new Gs(h, y, p, t));
            },
            error: i[a + 1],
            complete: i[a + 2]
        }, Ws(t._query);
    ...
    return function(t, e, n, r) {
        var i = this, o = new lo(r), s = new Ri(e, o, n);
        return t.asyncQueue.enqueueAndForget((function() {
            return b(i, void 0, void 0, (function() {
                var e;
                return _(this, (function(n) {
 ...
 */ var pu = /** @class */ function(t) {
     ...
     */    return w(e, t), e.prototype.get = function(e) {
        var n = this, r = au(e, this._firestore), i = new cu(this._firestore);
    ...
    return t.prototype.get = function(t) {
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = s(e)) || e instanceof us ? Ns(this._dataReader, "Transaction.update", u._key, e, n, r) : As(this._dataReader, "Transaction.update", u._key, e), 
                ...
                return b(e, void 0, void 0, (function() {
                    ...
                    return _(this, (function(r) {
                        switch (r.label) {
                          ...
                          case 1:
                            return e = r.sent(), [ 4 /*yield*/ , To(t) ];

                          case 2:
                            return n = r.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!0), function(t) {
                                var e = P(t);
                                return e.Or.delete(0 /* UserDisabled */), zr(e);
                            }(n)) ];
                        }
                    }));
                }));
 ...
 */;
        ...
        get: function() {
            if (!this.eu) throw new A(I.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.eu;
        },
        enumerable: !1,
        configurable: !0
        ...
        try {
            return new Lu(this, function(t, e) {
                if (t = Go(t, Wo), Mo("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new A(I.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
                return new Ho(t, 
                /* converter= */ null, 
                /**
 ...
 */
                    ...
                    return b(n, void 0, void 0, (function() {
                        ...
                        return _(this, (function(i) {
                            switch (i.label) {
                              ...
                              case 1:
                                return n = i.sent(), new yo(t.asyncQueue, n, e, r).run(), [ 2 /*return*/ ];
                            }
                        }));
                    }));
                })), r.promise;
    ...
    return w(e, t), e.prototype.convertBytes = function(t) {
        ...
        var e = this.convertDocumentKey(t, this.firestore._databaseId);
        return Nu.nu(e, this.firestore, /* converter= */ null);
    }, e;
}(iu);
 ...
 */ var Tu = /** @class */ function() {
    ...
    return t.prototype.get = function(t) {
        ...
        var s = Vu(t);
        return 2 === arguments.length ? this._delegate.update(s, e) : (r = this._delegate).update.apply(r, E([ s, e, n ], i)), 
        this;
    }, t.prototype.delete = function(t) {
        var e = Vu(t);
...
var Nu = /** @class */ function() {
    ...
    return t.ru = function(e, n, r) {
        ...
        return new t(n, new zo(n._delegate, r, new ot(e)));
    }, t.nu = function(e, n, r) {
        return new t(n, new zo(n._delegate, r, e));
    }, Object.defineProperty(t.prototype, "id", {
        get: function() {
        ...
        return (t = s(t)) instanceof zo && Zo(this._delegate, t);
    }, t.prototype.set = function(t, e) {
        ...
        try {
            return 1 === arguments.length ? hu(this._delegate, t) : hu.apply(void 0, E([ this._delegate, t, e ], n));
        } catch (t) {
 ...
 */    }, t.prototype.onSnapshot = function() {
        ...
        return ("cache" === (null == t ? void 0 : t.source) ? function(t) {
            ...
            return function(t, e) {
                                    ...
                                    return b(this, void 0, void 0, (function() {
                                        ...
                                        return _(this, (function(o) {
                                            switch (o.label) {
                                              ...
                                              case 1:
                                                return (i = o.sent()).isFoundDocument() ? n.resolve(i) : i.isNoDocument() ? n.resolve(null) : n.reject(new A(I.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                                [ 3 /*break*/ , 3 ];

                                              case 2:
                                                return r = o.sent(), i = wi(r, "Failed to get document '" + e + " from cache"), 
                ...
                return new Bs(e, r, t._key, n, new qs(null !== n && n.hasLocalMutations, 
            ...
            return new Ru(e.firestore, new Bs(e.firestore._delegate, e._userDataWriter, t._key, t._document, t.metadata, e._delegate.converter));
        }));
    }, t.prototype.withConverter = function(e) {
        return new t(this.firestore, e ? this._delegate.withConverter(Au.su(this.firestore, e)) : this._delegate.withConverter(null));
    }, t;
}();
...
var Ru = /** @class */ function() {
     ...
     */
        function(t) {
                                ...
                                return n = function(t, e, n) {
                                    return b(this, void 0, void 0, (function() {
                                        ...
                                        return _(this, (function(a) {
                                            switch (a.label) {
                                              case 0:
                                                return a.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , mr(t, e, 
                                                /* usePreviousResults= */ !0) ];
                                              ...
                                              case 2:
                                                return s = a.sent(), u = wi(s, "Failed to execute query '" + e + " against cache"), 
            ...
            t = Go(t, Ho);
            var e = Go(t.firestore, is), n = os(e), r = new cu(e);
            return Ws(t._query), So(n, t._query).then((function(n) {
                return new Gs(e, r, t, n);
            }));
        }(this._delegate)).then((function(t) {
            return new Pu(e.firestore, new Gs(e.firestore._delegate, e._userDataWriter, e._delegate, t._snapshot));
        }));
    }, t.prototype.onSnapshot = function() {
        for (var t = this, e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n];
        var r = Du(e), i = ku(e, (function(e) {
    ...
    return w(e, t), Object.defineProperty(e.prototype, "id", {
        ...
        return new e(this.firestore, t ? this._delegate.withConverter(Au.su(this.firestore, t)) : this._delegate.withConverter(null));
    }, e;
}(Lu);
 ...
 */ var Mu = /** @class */ function() {
    ...
    function t() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        this._delegate = new (us.bind.apply(us, E([ void 0 ], t)));
    }
    return t.documentId = function() {
        ...
        return (t = s(t)) instanceof us && this._delegate._internalPath.isEqual(t._internalPath);
    }, t;
}(), Uu = /** @class */ function() {
    function t(t) {
        this._delegate = t;
...
function qu(t) {
    ...
    }(os(e = Go(e, is)), n).then((function(t) {
        return t ? new Ho(e, null, t.query) : null;
    }))).then((function(t) {
        return t ? new Lu(r, t) : null;
    }));
}

export { hs as D, is as E, Nu as G, Tu as K, wu as L, x as O, Eu as Q, Cu as X, Ru as Y, Lu as Z, mu as a, qu as c, Pu as e, Mu as i, Iu as j, Fu as n, xu as o, rs as p, bu as q, Uu as r };
//# sourceMappingURL=prebuilt-a02dc3a2-2af4bdc1.js.map
