...
function loadBundle(data) {
    return databaseA167970f.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    var _this = this;
    return databaseA167970f.namedQuery(this._delegate, queryName).then(function (expQuery) {
        if (!expQuery) {
            return null;
        }
        return new databaseA167970f.Query$1(_this, 
...
registerBundle(databaseA167970f.Firestore);
