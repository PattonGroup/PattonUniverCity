...
import { useFirestoreEmulator as o, enableNetwork as i, disableNetwork as a, waitForPendingWrites as u, onSnapshotsInSync as s, collection as c, doc as f, collectionGroup as l, runTransaction as h, ensureFirestoreConfigured as p, WriteBatch as d, executeWrite as g, Bytes as y, AbstractUserDataWriter as m, DocumentSnapshot as _, QueryDocumentSnapshot as v, DocumentReference as w, refEqual as b, setDoc as P, updateDoc as S, deleteDoc as I, onSnapshot as D, getDocFromCache as E, getDocFromServer as O, getDoc as F, snapshotEqual as j, query as x, where as A, orderBy as C, limit as N, limitToLast as T, startAt as B, startAfter as R, endBefore as q, endAt as Q, queryEqual as W, getDocsFromCache as L, getDocsFromServer as U, getDocs as k, QuerySnapshot as V, addDoc as K, FieldPath as z, serverTimestamp as M, deleteField as G, arrayUnion as Z, arrayRemove as $, increment as J, loadBundle as Y, namedQuery as H, GeoPoint as X, Timestamp as ee, CACHE_SIZE_UNLIMITED as te, enableIndexedDbPersistence as re, enableMultiTabIndexedDbPersistence as ne, clearIndexedDbPersistence as oe } from "@firebase/firestore";
...
var Te = /** @class */ function() {
    ...
    return e.forPath = function(t, r, n) {
        ...
        var t = this;
        return ("cache" === (null == e ? void 0 : e.source) ? E(this._delegate) : "server" === (null == e ? void 0 : e.source) ? O(this._delegate) : F(this._delegate)).then((function(e) {
...
var Qe = /** @class */ function() {
    ...
    return Object.defineProperty(e.prototype, "ref", {
        ...
        return j(this._delegate, e._delegate);
    }, e;
}(), We = /** @class */ function(t) {
    function r() {
        return null !== t && t.apply(this, arguments) || this;
    ...
    return e.prototype.where = function(t, r, n) {
        ...
        try {
            return new e(this.firestore, x(this._delegate, N(t)));
        } catch (e) {
        ...
        try {
            return new e(this.firestore, x(this._delegate, B.apply(void 0, t)));
        } catch (e) {
 ...
 * limitations under the License.
 */ function ze(e) {
    return Y(this._delegate, e);
}

function Me(e) {
    var t = this;
    return H(this._delegate, e).then((function(e) {
        return e ? new Le(t, 
