 ...
 */ function D(t = "Unexpected state") {
    ...
    const e = "FIRESTORE (8.6.5) INTERNAL ASSERTION FAILED: " + t;
 ...
 */ class ot {
    ...
    static fromPath(t) {
        return new ot(K.fromString(t));
    }
    static fromName(t) {
        return new ot(K.fromString(t).popFirst(5));
    }
 ...
 */ (t, e) && function(t, e) {
    ...
    /** Makes sure a document is within the bounds, if provided. */ (t, e) && function(t, e) {
        if (t.startAt && !Kt(t.startAt, te(t), e)) return !1;
        if (t.endAt && Kt(t.endAt, te(t), e)) return !1;
        return !0;
    }
    /**
 ...
 */ function de(t, e, n) {
    ...
    }(n, e) : t instanceof ye ? ge(t, e) : t instanceof pe ? Ee(t, e) : function(t, e) {
 ...
 */ function we(t, e, n) {
    ...
    // applications.
    return t instanceof ye ? ge(t, e) : t instanceof pe ? Ee(t, e) : n;
}
...
/** Transforms an array value via a union operation. */ class ye extends fe {
    constructor(t) {
...
function be(t, e) {
    return t.field.isEqual(e.field) && function(t, e) {
        return t instanceof ye && e instanceof ye || t instanceof pe && e instanceof pe ? $(t.elements, e.elements, ut) : t instanceof Te && e instanceof Te ? ut(t.A, e.A) : t instanceof me && e instanceof me;
 ...
 *     Code.UNKNOWN.
 */ (Ke = Qe || (Qe = {}))[Ke.OK = 0] = "OK", Ke[Ke.CANCELLED = 1] = "CANCELLED", 
...
function Dn(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? K.emptyPath() : Nn(e);
}
...
function Kn(t) {
    return t ? void 0 !== t.unaryFilter ? [ Xn(t) ] : void 0 !== t.fieldFilter ? [ Yn(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((t => Kn(t))).reduce(((t, e) => t.concat(e))) : D() : [];
}
 ...
 */ function is(t) {
    ...
    const e = t.length;
    if (C(e >= 2), 2 === e) return C("" === t.charAt(0) && "" === t.charAt(1)), K.emptyPath();
...
/** Name of the IndexedDb object store. */ gs.store = "clientMetadata", 
...
// Visible for testing
const Ts = [ ...[ ...[ ...[ ...[ cs.store, us.store, as.store, fs.store, ws.store, os.store, ms.store, _s.store ], gs.store ], ds.store ], ys.store ], ps.store, Es.store ], Is = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.";
 ...
 */ class ei {
    ...
    add(t) {
        const e = t.lastSegment(), n = t.popLast(), s = this.index[e] || new Je(K.comparator), i = !s.has(n);
    ...
    getEntries(t) {
        return (this.index[t] || new Je(K.comparator)).toArray();
    }
}
...
class ui {
    ...
    // PORTING NOTE: Multi-tab only.
    jt(t, e) {
        return this.Qt[e] ? bs.resolve(this.Qt[e]) : this.lookupMutationBatch(t, e).next((t => {
            if (t) {
                const n = t.keys();
    ...
    ue(t) {
        ...
        v("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`), this.ce = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , e, (async () => {
            ...
            try {
                ...
                Ds(t) ? v("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t) : await gi(t);
            }
            await this.ue(t);
        }));
    }
        ...
        return this.we(t, ((r, o) => {
            if (o <= e) {
                const e = this._e(t, r).next((e => {
                    ...
                    // removing them.
                    return i++, n.getEntry(t, r).next((() => (n.removeEntry(r), yi(t).delete([ 0, es(r.path) ]))));
                }));
                s.push(e);
            }
 ...
 */ class Pi {
    ...
    getEntry(t, e) {
        return Di(t).get(Ci(e)).next((t => this.ye(e, t)));
    }
    /**
 ...
 */ (t);
    ...
    Pe(t, e) {
        ...
        const n = e.store(ys.store), s = new ei, i = t => {
            if (s.add(t)) {
...
class ki {
    ...
    a) {
        ...
        this.Me = t => Promise.resolve(), !ki.yt()) throw new A(I.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
 ...
 */
        ...
        (this.R, this.Ut), this.Qe = new Ys, this.window && this.window.localStorage ? this.Ke = this.window.localStorage : (this.Ke = null, 
     ...
     * primary lease.
     */    je() {
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (t => Oi(t).put(new gs(this.clientId, Date.now(), this.networkEnabled, this.inForeground)).next((() => {
    ...
    async shutdown() {
        ...
        await this.Be.runTransaction("shutdown", "readwrite", [ os.store, gs.store ], (t => {
    ...
    getMutationQueue(t) {
        return ui.Kt(t, this.R, this.Ut, this.referenceDelegate);
    }
    getTargetCache() {
        return this.qe;
    }
...
async function sr(t, e, n, s) {
    ...
    const u = i.On.newChangeBuffer({
        ...
        return ee(zt(K.fromString(`__bundle__/docs/${t}`)));
    }(s));
 ...
 */ class rr {
    ...
    getBundleMetadata(t, e) {
        return bs.resolve(this.Kn.get(e));
    }
    saveBundleMetadata(t, e) {
 ...
 */ class or {
     ...
     * removed.
     */    Zn(t) {
        const e = new ot(new K([])), n = new cr(e, t), s = new cr(e, t + 1), i = [];
    ...
    es(t) {
        const e = new ot(new K([])), n = new cr(e, t), s = new cr(e, t + 1);
        let i = on();
        return this.zn.forEachInRange([ n, s ], (t => {
            i = i.add(t.key);
        })), i;
 ...
 */ class lr {
    constructor(t) {
         ...
         * IDs.
         */
        this._s = new or, this.targetCount = 0, this.ys = di.Jt();
    }
    forEachTarget(t, e) {
    ...
    allocateTargetId(t) {
        return this.highestTargetId = this.ys.next(), bs.resolve(this.highestTargetId);
    }
    setTargetsMetadata(t, e, n) {
    ...
    te(t) {
        ...
        const e = t.targetId;
        e > this.highestTargetId && (this.ys = new di(e), this.highestTargetId = e), t.sequenceNumber > this.ws && (this.ws = t.sequenceNumber);
    }
    addTargetData(t, e) {
...
class fr {
    ...
    constructor(t, e) {
        ...
        this.Ut = new ti, this.Ue = function(t, e) {
            return new ar(t, e);
        }(this.Ut, (t => this.referenceDelegate.ps(t))), this.R = new Bs(e), this.Qe = new rr(this.R);
    }
    start() {
    ...
    getMutationQueue(t) {
        ...
        return e || (e = new ur(this.Ut, this.referenceDelegate), this.gs[t.toKey()] = e), 
        e;
    }
    getTargetCache() {
        return this.qe;
    ...
    Is(t, e) {
        return bs.or(Object.values(this.gs).map((n => () => n.containsKey(t, e))));
    }
}
 ...
 */ (this.persistenceKey), this.ks = this.ks.insert(this.Ns, new Ar), this.Ls = new RegExp(`^firestore_clients_${r}_([^_]*)$`), 
    ...
    addLocalQueryTarget(t) {
        ...
        // by another tab
            ...
            const n = this.storage.getItem(gr(this.persistenceKey, t));
            if (n) {
                const s = Er.Vs(t, n);
                s && (e = s.state);
            }
 ...
 */ (e.newValue);
    ...
    zs(t, e, n) {
        const s = new pr(this.currentUser, t, e, n), i = yr(this.persistenceKey, this.currentUser, t);
        this.setItem(i, s.Ss());
    }
    Hs(t) {
    ...
    Ys(t, e, n) {
        const s = gr(this.persistenceKey, t), i = new Er(t, e, n);
        this.setItem(s, i.Ss());
    }
    Zs() {
 ...
 */ function wo(t) {
    ...
    t.Qr = function(t, e, n) {
        ...
        await no(t)) : (await t.Qr.stop(), t.kr.length > 0 && (v("RemoteStore", `Stopping write stream with ${t.kr.length} pending writes`), 
        t.kr = []));
    }))), t.Qr;
}
...
class po {
    ...
    /** Returns a view snapshot as if all documents in the snapshot were added. */    static fromInitialDocuments(t, e, n, s) {
        ...
        })), new po(t, e, yo.emptySet(e), i, n, s, 
        /* syncStateChanged= */ !0, 
 ...
 */ class So {
     ...
     */    Un(t) {
        return t.metadata.exists ? Fn(this.R, t.document, !1) : At.newNoDocument(this.qn(t.metadata.name), this.Qn(t.metadata.readTime));
    }
    Qn(t) {
        return Rn(t);
    }
 ...
 */ class Fo {
    ...
    e) {
        ...
        this.mutatedKeys = on(), this.lo = ce(t), this.fo = new yo(this.lo);
    }
    /**
     ...
     */    _o(t, e) {
        const n = e ? e.mo : new go, s = e ? e.fo : this.fo;
...
async function Mo(t, e) {
    ...
    s = r.targetId, n.sharedClientState.addLocalQueryTarget(s), i = r.view.Ro(); else {
        ...
        s = t.targetId, i = await Lo(n, e, s, "current" === r), n.isPrimaryClient && Qr(n.remoteStore, t);
    }
    return i;
}
 ...
 */ async function Ko(t, e, n) {
    ...
    /* keepPersistedTargetData */ !1).then((() => Jo(s, e, n))).catch(gi);
}
...
function Yo(t, e) {
    ...
    const n = t.Do.get(e);
    null !== n && (Kr(t.remoteStore, n), t.Do = t.Do.remove(e), t.Co.delete(n), tc(t));
}
 ...
 */ function tc(t) {
    for (;t.So.size > 0 && t.Do.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.So.delete(e);
        const n = new ot(K.fromString(e)), s = t.ko.next();
        t.Co.set(s, new $o(n)), t.Do = t.Do.insert(n, s), Qr(t.remoteStore, new Ls(ee(zt(n.path)), s, 2 /* LimboResolution */ , T.o));
    }
}
...
function dc(t) {
    ...
    e.remoteStore.remoteSyncer.rejectListen = Ko.bind(null, e), e.vo._r = Ro.bind(null, e.eventManager), 
...
class mc {
    ...
    Qo(t) {
        return Ki(this.persistence, new Ui, t.initialUser, this.R);
    }
    qo(t) {
 ...
 */ class yc extends mc {
    ...
    async initialize(t) {
        await super.initialize(t), await nr(this.localStore), await this.Ko.initialize(this, t), 
        // Enqueue writes from a previous session
        await wc(this.Ko.syncEngine), await no(this.Ko.remoteStore);
    }
    Qo(t) {
        return Ki(this.persistence, new Ui, t.initialUser, this.R);
    }
 ...
 */ class gc extends yc {
    ...
    async initialize(t) {
        ...
        await this.persistence.He((async t => {
            await cc(this.Ko.syncEngine, t), this.gcScheduler && (t && !this.gcScheduler.started ? this.gcScheduler.start(this.localStore) : t || this.gcScheduler.stop());
        }));
    }
    Bo(t) {
        const e = Cr();
        if (!Rr.yt(e)) throw new A(I.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
 ...
 */ class pc {
    ...
    createRemoteStore(t) {
        ...
        r = Pr.yt() ? new Pr : new vr, new Br(e, n, s, i, r);
        var e, n, s, i, r;
...
class Yc {
    constructor(t) {
        ...
        const e = t => {
            v("FirebaseCredentialsProvider", "Auth detected"), this.auth = t, this.lc(), this.auth.addAuthTokenListener(this.ac);
        };
        t.onInit((t => e(t))), 
        ...
        setTimeout((() => {
            if (!this.auth) {
                ...
                // with null token
                v("FirebaseCredentialsProvider", "Auth not yet detected"), this.asyncQueue.enqueueRetryable((() => this.changeListener(this.currentUser))));
            }
        }), 0);
    }
    getToken() {
 ...
 */ class Xc {
    constructor(t, e, n) {
        this.fc = t, this.dc = e, this.wc = n, this.type = "FirstParty", this.user = _r.FIRST_PARTY;
    }
    get authHeaders() {
        const t = {
 ...
 */ class Zc {
    ...
    getToken() {
        return Promise.resolve(new Xc(this.fc, this.dc, this.wc));
    }
    setChangeListener(t, e) {
 ...
 */ (t)), t;
    ...
    enqueueAfterDelay(t, e, n) {
        ...
        const s = _o.createAndSchedule(this, t, e, n, (t => this.Pc(t)));
...
class Iu extends au {
    /** @hideconstructor */
    constructor(t, e) {
        super(t, e), this.type = "firestore", this._queue = new gu, this._persistenceKey = "name" in t ? t.name : "[DEFAULT]";
    }
    _terminate() {
...
function vu(t) {
    ...
    return t._queue.enqueueAndForgetEvenWhileRestricted((async () => {
        try {
            await async function(t) {
                if (!Ps.yt()) return Promise.resolve();
                const e = t + "main";
                await Ps.delete(e);
...
/** A "context" object passed around while parsing user data. */ class Ou {
    ...
    Bc(t) {
        return sa(t, this.settings.methodName, this.settings.qc || !1, this.path, this.settings.Uc);
    }
    ...
    Oc(t) {
        ...
        if ($u(this.xc) && xu.test(t)) throw this.Bc('Document fields cannot begin and end with "__"');
    }
}
...
class Ku extends Cu {
    ...
    _toFieldTransform(t) {
        const e = Uu(this, t, 
        /*array=*/ !0), n = this.Kc.map((t => Ju(t, e))), s = new ye(n);
...
class ju extends Cu {
    ...
    _toFieldTransform(t) {
        const e = Uu(this, t, 
        /*array=*/ !0), n = this.Kc.map((t => Ju(t, e))), s = new pe(n);
        return new Re(t.path, s);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class Wu extends Cu {
    ...
    _toFieldTransform(t) {
        const e = new Te(t.R, le(t.R, this.jc));
 ...
 */
    return function(t, e) {
        ...
        if (!$u(e.xc)) throw e.Bc(`${t._methodName}() can only be used with update() and set()`);
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        throw e.Bc(`Unsupported field value: ${ru(t)}`);
    }
    /**
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((s => {
                    const i = new ha(t._firestore, t._userDataWriter, s.doc.key, s.doc, new ua(t._snapshot.mutatedKeys.has(s.doc.key), t._snapshot.fromCache), t.query.converter);
                    return e = s.doc, {
                        type: "added",
                        doc: i,
                        oldIndex: -1,
 ...
 */ class pa extends _a {
    ...
    _apply(t) {
        return new lu(t.firestore, t.converter, ne(t._query, this.Jc, this.Yc));
    }
}
 ...
 */ class Ea extends _a {
    ...
    _apply(t) {
        const e = Ia(t, this.type, this.Xc, this.Zc);
        return new lu(t.firestore, t.converter, function(t, e) {
 ...
 */ class qa {
    enableIndexedDbPersistence(t, e) {
        return function(t, e) {
            ...
            return bu(n, i, new yc(i, s.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
        }
        /**
 ...
 */ (t._delegate, {
    ...
    enableMultiTabIndexedDbPersistence(t) {
        return function(t) {
            ...
            return bu(e, s, new gc(s, n.cacheSizeBytes));
        }(t._delegate);
    }
...
class Qa extends va {
    ...
    convertReference(t) {
        const e = this.convertDocumentKey(t, this.firestore._databaseId);
        return za.nu(e, this.firestore, /* converter= */ null);
    }
}
 ...
 */ class Ga {
    ...
    static su(t, e) {
        ...
        let i = s.get(e);
        return i || (i = new Ga(t, new Qa(t), e), s.set(e, i)), i;
    }
}
 ...
 */ (this._delegate) : function(t) {
    ...
    withConverter(t) {
        return new za(this.firestore, t ? this._delegate.withConverter(Ga.su(this.firestore, t)) : this._delegate.withConverter(null));
    }
}
 ...
 */ (this._delegate) : "server" === (null == t ? void 0 : t.source) ? function(t) {
    ...
    withConverter(t) {
        return new th(this.firestore, t ? this._delegate.withConverter(Ga.su(this.firestore, t)) : this._delegate.withConverter(null));
    }
}
...
class sh extends th {
    ...
    withConverter(t) {
        return new sh(this.firestore, t ? this._delegate.withConverter(Ga.su(this.firestore, t)) : this._delegate.withConverter(null));
    }
}
...
function uh(t) {
    return (e = this._delegate, n = t, Kc(Au(e = ou(e, Iu)), n).then((t => t ? new lu(e, null, t.query) : null))).then((t => t ? new th(this, t) : null));
    var e, n;
}

export { Iu as I, Ka as K, M, Nu as N, Tu as T, Ua as U, Wa as W, Xa as X, Za as Z, Ma as a, ch as c, ja as j, nh as n, oh as o, qa as q, rh as r, sh as s, th as t, uh as u, za as z };
//# sourceMappingURL=prebuilt.rn-27f582f0.js.map
