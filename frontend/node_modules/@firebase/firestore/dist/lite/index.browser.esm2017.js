 ...
 */ class jt {
     ...
     */    setAll(t) {
        let e = Z.emptyPath(), n = {}, s = [];
        t.forEach(((t, r) => {
            if (!e.isImmediateParentOf(r)) {
                // Insert the accumulated changes at this parent location
                const t = this.getFieldsMap(e);
                this.applyChanges(t, n, s), n = {}, s = [], e = r.popLast();
            }
            t ? n[r.lastSegment()] = kt(t) : s.push(r.lastSegment());
        }));
 ...
 * property.
 */ function Qt(t, e = null, n = [], s = [], r = null, i = null, o = null) {
    return new Bt(t, e, n, s, r, i, o);
}
...
class zt extends class {} {
     ...
     */    static create(t, e, n) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.S(t, e, n) : new Wt(t, e, n) : "array-contains" /* ARRAY_CONTAINS */ === e ? new Kt(t, n) : "in" /* IN */ === e ? new Jt(t, n) : "not-in" /* NOT_IN */ === e ? new Zt(t, n) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new Xt(t, n) : new zt(t, e, n);
    }
    static S(t, e, n) {
 ...
 */ function ce(t) {
    ...
    if (null === e.C) {
        ...
        t.isKeyField() || e.C.push(new ee(t)), e.C.push(new ee(Z.keyField(), "asc" /* ASCENDING */)); else {
            let t = !1;
 ...
 */ function he(t) {
    const e = b(t);
    if (!e.L) if ("F" /* First */ === e.limitType) e.L = Qt(e.path, e.collectionGroup, ce(e), e.filters, e.limit, e.startAt, e.endAt); else {
        ...
        e.L = Qt(e.path, e.collectionGroup, t, e.filters, e.limit, n, s);
    }
    return e.L;
}
...
function Le(t, e) {
    return "found" in e ? function(t, e) {
        ...
        const n = qe(t, e.found.name), s = $e(e.found.updateTime), r = new jt({
            mapValue: {
        ...
        const n = qe(t, e.missing), s = $e(e.readTime);
...
class He {
     ...
     */ , r = 6e4) {
        this.M = t, this.timerId = e, this.B = n, this.W = s, this.G = r, this.H = 0, this.Y = null, 
     ...
     */    Z(t) {
        ...
        this.Y = this.M.enqueueAfterDelay(this.timerId, s, (() => (this.K = Date.now(), 
        t()))), 
...
async function Ke(t, e) {
    const n = b(t), s = Oe(n.k) + "/documents", r = {
        writes: e.map((t => Ue(n.k, t)))
    };
...
function tn(t) {
    ...
    if (!Xe.has(t)) {
        ...
        new G(e, n, s, r.host, r.ssl, r.experimentalForceLongPolling, r.experimentalAutoDetectLongPolling, r.useFetchStreams))), o = Ge(t._databaseId), u = function(t, e, n) {
            return new Ye(t, e, n);
        }(t._credentials, i, o);
        Xe.set(t, u);
    }
 ...
 * Security Rules.
 */ function on(t, e, n, s = {}) {
    const r = (t = rt(t, nn))._getSettings();
 ...
 * terminated.
 */ function un(t) {
    return t = rt(t, nn), n(t.app, "firestore/lite"), t._delete();
}
...
function ln(t, e, ...n) {
    if (t = a(t), tt("collection", "path", e), t instanceof nn) {
        const s = K.fromString(e, ...n);
        return nt(s), new hn(t, /* converter= */ null, s);
    }
    {
        if (!(t instanceof an || t instanceof hn)) throw new U(A, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = K.fromString(t.path, ...n).child(K.fromString(e));
        return nt(s), new hn(t.firestore, 
        /* converter= */ null, s);
    }
}
 ...
 */ function fn(t, e) {
    if (t = rt(t, nn), tt("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new U(A, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
    return new cn(t, 
    /* converter= */ null, 
    /**
...
function dn(t, e, ...n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = wt.$()), tt("doc", "path", e), t instanceof nn) {
        const s = K.fromString(e, ...n);
        return et(s), new an(t, 
        /* converter= */ null, new X(s));
    }
    {
        if (!(t instanceof an || t instanceof hn)) throw new U(A, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = t._path.child(K.fromString(e, ...n));
        return et(s), new an(t.firestore, t instanceof hn ? t.converter : null, new X(s));
    }
}
 ...
 * Firestore database.
 */ function wn(t, e) {
    return t = a(t), e = a(e), (t instanceof an || t instanceof hn) && (e instanceof an || e instanceof hn) && (t.firestore === e.firestore && t.path === e.path && t.converter === e.converter);
}
 ...
 * Firestore database.
 */ function mn(t, e) {
    return t = a(t), e = a(e), t instanceof cn && e instanceof cn && (t.firestore === e.firestore && le(t._query, e._query) && t.converter === e.converter);
}
...
/** A "context" object passed around while parsing user data. */ class An {
    ...
    /** Returns a new context with the specified settings overwritten. */    ot(t) {
        return new An(Object.assign(Object.assign({}, this.settings), t), this.databaseId, this.k, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
    }
    ut(t) {
        var e;
    ...
    ft(t) {
        return zn(t, this.settings.methodName, this.settings.dt || !1, this.path, this.settings.wt);
    }
    ...
    ct(t) {
        ...
        if (In(this.it) && bn.test(t)) throw this.ft('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ class Pn {
    constructor(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.k = n || Ge(t);
    }
...
/** Parse document data from a set() call. */ function Vn(t, e, n, s, r, i = {}) {
...
class Fn extends gn {
    ...
    _toFieldTransform(t) {
        const e = Dn(this, t, 
        /*array=*/ !0), n = this._t.map((t => Ln(t, e))), s = new me(n);
        return new _e(t.path, s);
    }
    isEqual(t) {
...
class Sn extends gn {
    ...
    _toFieldTransform(t) {
        const e = Dn(this, t, 
        /*array=*/ !0), n = this._t.map((t => Ln(t, e))), s = new pe(n);
        return new _e(t.path, s);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class qn extends gn {
    ...
    _toFieldTransform(t) {
        const e = new ye(t.k, fe(t.k, this.gt));
...
/** Parse update data from an update() call. */ function xn(t, e, n, s) {
    ...
    const u = new bt(i);
    return new Tn(o, u, r.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function On(t, e, n, s, r, i) {
 ...
 */ function Cn(t, e, n, s = !1) {
    return Ln(n, t.yt(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Ln(t, e) {
    ...
    // from firestore-exp.
    t = a(t))) return jn("Unsupported field value:", e, t), Un(t, e);
    if (t instanceof gn) 
 ...
 */
    return function(t, e) {
        ...
        if (!In(e.it)) throw e.ft(`${t._methodName}() can only be used with update() and set()`);
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        if (t instanceof _n) return {
            bytesValue: Ne(e.k, t._byteString)
        };
        if (t instanceof an) {
...
function kn(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof yt || t instanceof vn || t instanceof _n || t instanceof an || t instanceof gn);
}
 ...
 */ function Mn(t, e, n) {
    ...
    // FieldPath.
    e = a(e)) instanceof pn) return e._internalPath;
 ...
 */ function Kn(t, e) {
    return t = a(t), e = a(e), t instanceof Gn && e instanceof Gn ? t._firestore === e._firestore && t._key.isEqual(e._key) && (null === t._document ? null === e._document : t._document.isEqual(e._document)) && t._converter === e._converter : t instanceof Yn && e instanceof Yn && (mn(t.query, e.query) && pt(t.docs, e.docs, Kn));
}
...
class ts extends Zn {
    ...
    _apply(t) {
        const e = Rn(t.firestore), n = function(t, e, n, s, r, i, o) {
            let u;
            if (r.isKeyField()) {
                ...
                if ("in" /* IN */ === i || "not-in" /* NOT_IN */ === i) {
                    ms(o, i);
                    const e = [];
                    for (const n of o) e.push(ws(s, t, n));
                    u = {
                        arrayValue: {
                            values: e
                        }
            ...
            } else "in" /* IN */ !== i && "not-in" /* NOT_IN */ !== i && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== i || ms(o, i), 
            u = Cn(n, e, o, 
            /* allowArrays= */ "in" /* IN */ === i || "not-in" /* NOT_IN */ === i);
            const a = zt.create(r, i, u);
            return function(t, e) {
                if (e.O()) {
                    const n = ue(t);
 ...
 * @returns The created `Query`.
 */ function is(t) {
    return it("limit", t), new rs("limit", t, "F" /* First */);
}
 ...
 * @returns The created `Query`.
 */ function os(t) {
    return it("limitToLast", t), new rs("limitToLast", t, "L" /* Last */);
}
...
class us extends Zn {
    ...
    _apply(t) {
        const e = ds(t, this.type, this.Pt, this.Rt);
        return new cn(t.firestore, t.converter, function(t, e) {
...
/** Helper function to create a bound from a document or fields */ function ds(t, e, n, s) {
    if (n[0] = a(n[0]), n[0] instanceof Gn) return function(t, e, n, s, r) {
        ...
        // results.
                for (const n of ce(t)) if (n.field.isKeyField()) i.push(xt(e, s.key)); else {
        ...
        return function(t, e, n, s, r, i) {
            ...
            for (let i = 0; i < r.length; i++) {
                ...
                if (o[i].field.isKeyField()) {
                    ...
                    if (!ae(t) && -1 !== a.indexOf("/")) throw new U(A, `Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to ${s}() must be a plain document ID, but '${a}' contains a slash.`);
...
function ws(t, e, n) {
    if ("string" == typeof (n = a(n))) {
        ...
        if (!ae(e) && -1 !== n.indexOf("/")) throw new U(A, `Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
 ...
 * document contents.
 */ function gs(t) {
    const e = tn((t = rt(t, an)).firestore), n = new _s(t.firestore);
    return Je(e, [ t._key ]).then((e => {
        v(1 === e.length);
        const s = e[0];
        return new Gn(t.firestore, n, t._key, s.isFoundDocument() ? s : null, t.converter);
    }));
}
 ...
 */ function vs(t) {
    ...
    const e = tn(t.firestore), n = new _s(t.firestore);
    return Ze(e, t._query).then((e => {
        const s = e.map((e => new Hn(t.firestore, n, e.key, e, t.converter)));
        return ie(t._query) && 
        // Limit to last queries reverse the orderBy constraint that was
        // specified by the user. As such, we need to reverse the order of the
        // results to return the documents in the expected order.
        s.reverse(), new Yn(t, s);
    }));
}

function bs(t, e, n) {
    const s = ys((t = rt(t, an)).converter, e, n), r = Vn(Rn(t.firestore), "setDoc", t._key, s, null !== t.converter, n);
    return Ke(tn(t.firestore), [ r.toMutation(t._key, ge.none()) ]);
}

function Es(t, e, n, ...s) {
    const r = Rn((t = rt(t, an)).firestore);
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
        let i;
    i = "string" == typeof (e = a(e)) || e instanceof pn ? On(r, "updateDoc", t._key, e, n, s) : xn(r, "updateDoc", t._key, e);
 ...
 */ function Ts(t) {
    return Ke(tn((t = rt(t, an)).firestore), [ new Te(t._key, ge.none()) ]);
}
 ...
 */ function Is(t, e) {
    const n = dn(t = rt(t, hn)), s = ys(t.converter, e), r = Vn(Rn(t.firestore), "addDoc", n._key, s, null !== n.converter, {});
    return Ke(tn(t.firestore), [ r.toMutation(n._key, ge.exists(!1)) ]).then((() => n));
}
 ...
 */ class Ds {
    ...
    set(t, e, n) {
        ...
        const s = $s(t, this._firestore), r = ys(s.converter, e, n), i = Vn(this._dataReader, "WriteBatch.set", s._key, r, null !== s.converter, n);
        return this._mutations.push(i.toMutation(s._key, ge.none())), this;
    }
    update(t, e, n, ...s) {
        this._verifyNotCommitted();
        ...
        // performing validation.
                let i;
        return i = "string" == typeof (e = a(e)) || e instanceof pn ? On(this._dataReader, "WriteBatch.update", r._key, e, n, s) : xn(this._dataReader, "WriteBatch.update", r._key, e), 
        this._mutations.push(i.toMutation(r._key, ge.exists(!0))), this;
    }
    /**
 ...
 * writes.
 */ function Fs(t) {
    const e = tn(t = rt(t, nn));
    return new Ds(t, (t => Ke(e, t)));
}
...
class qs {
    constructor(t, e, n, s) {
        ...
        this.Vt = 5, this.Nt = new He(this.asyncQueue, "transaction_retry" /* TransactionRetry */);
    }
    ...
    Dt() {
        this.Nt.Z((async () => {
            const t = new Ss(this.datastore), e = this.$t(t);
            e && e.then((e => {
 ...
 */ class Os {
     ...
     */    static createAndSchedule(t, e, n, s, r) {
        const i = Date.now() + n, o = new Os(t, e, i, s, r);
        return o.start(n), o;
    }
    /**
 ...
 */ class Cs {
    constructor() {
        ...
        this.Nt = new He(this, "async_queue_retry" /* AsyncQueueRetry */), 
    ...
    enqueue(t) {
        return this.Mt(), this.Ot ? new Promise((t => {})) : this.Bt(t);
    }
    enqueueRetryable(t) {
        this.enqueueAndForget((() => (this.xt.push(t), this.Qt())));
    }
    /**
     ...
     */    async Qt() {
        if (0 !== this.xt.length) {
            try {
                await this.xt[0](), this.xt.shift(), this.Nt.reset();
            } catch (t) {
                if (!
                /**
 * @license
 ...
 */ (t)) throw t;
 // Failure will be handled by AsyncQueue
    ...
    Bt(t) {
        const e = this.qt.then((() => (this.Ut = !0, t().catch((t => {
            this.Lt = t, this.Ut = !1;
 ...
 */ (t)), t;
    ...
    enqueueAfterDelay(t, e, n) {
        ...
        const s = Os.createAndSchedule(this, t, e, n, (t => this.zt(t)));
...
class Ls {
     ...
     */    get(t) {
        const e = $s(t, this._firestore), n = new _s(this._firestore);
        return this._transaction.lookup([ e._key ]).then((t => {
            if (!t || 1 !== t.length) return g();
            const s = t[0];
            if (s.isFoundDocument()) return new Gn(this._firestore, n, s.key, s, e.converter);
            if (s.isNoDocument()) return new Gn(this._firestore, n, e._key, null, e.converter);
            throw g();
        }));
    }
    set(t, e, n) {
        const s = $s(t, this._firestore), r = ys(s.converter, e, n), i = Vn(this._dataReader, "Transaction.set", s._key, r, null !== s.converter, n);
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let i;
        return i = "string" == typeof (e = a(e)) || e instanceof pn ? On(this._dataReader, "Transaction.update", r._key, e, n, s) : xn(this._dataReader, "Transaction.update", r._key, e), 
 ...
 */ function Us(t, e) {
    const n = tn(t = rt(t, nn)), s = new k;
    return new qs(new Cs, n, (n => e(new Ls(t, n))), s).run(), s.promise;
}
 ...
 */ !function(t) {
    ...
    const n = t.getProvider("app-exp").getImmediate(), s = new nn(n, t.getProvider("auth-internal"));
    return e && s._setSettings(e), s;
}), "PUBLIC" /* PUBLIC */)), r("firestore-lite", "2.3.4", "node");

export { _n as Bytes, hn as CollectionReference, an as DocumentReference, Gn as DocumentSnapshot, pn as FieldPath, gn as FieldValue, nn as FirebaseFirestore, U as FirestoreError, vn as GeoPoint, cn as Query, Zn as QueryConstraint, Hn as QueryDocumentSnapshot, Yn as QuerySnapshot, yt as Timestamp, Ls as Transaction, Ds as WriteBatch, Is as addDoc, Vs as arrayRemove, Rs as arrayUnion, ln as collection, fn as collectionGroup, Ts as deleteDoc, As as deleteField, dn as doc, yn as documentId, fs as endAt, ls as endBefore, gs as getDoc, vs as getDocs, rn as getFirestore, Ns as increment, sn as initializeFirestore, is as limit, os as limitToLast, ss as orderBy, Xn as query, mn as queryEqual, wn as refEqual, Us as runTransaction, Ps as serverTimestamp, bs as setDoc, w as setLogLevel, Kn as snapshotEqual, cs as startAfter, as as startAt, un as terminate, Es as updateDoc, on as useFirestoreEmulator, es as where, Fs as writeBatch };
