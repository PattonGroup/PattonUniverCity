 ...
 */ class Bt {
     ...
     */    setAll(t) {
        ...
        t.forEach(((t, r) => {
            ...
            t ? n[r.lastSegment()] = Mt(t) : s.push(r.lastSegment());
        }));
 ...
 * property.
 */ function Wt(t, e = null, n = [], s = [], r = null, i = null, o = null) {
    return new zt(t, e, n, s, r, i, o);
}
...
class Gt extends class {} {
     ...
     */    static create(t, e, n) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.S(t, e, n) : new Ht(t, e, n) : "array-contains" /* ARRAY_CONTAINS */ === e ? new Zt(t, n) : "in" /* IN */ === e ? new Xt(t, n) : "not-in" /* NOT_IN */ === e ? new te(t, n) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new ee(t, n) : new Gt(t, e, n);
    }
    static S(t, e, n) {
    ...
    matches(t) {
        ...
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.q(xt(e, this.value)) : null !== e && Ft(this.value) === Ft(e) && this.q(xt(e, this.value));
 ...
 */ function le(t) {
    ...
    if (null === e.C) {
        ...
        t.isKeyField() || e.C.push(new se(t)), e.C.push(new se(X.keyField(), "asc" /* ASCENDING */)); else {
            let t = !1;
 ...
 */ function fe(t) {
    const e = E(t);
    if (!e.L) if ("F" /* First */ === e.limitType) e.L = Wt(e.path, e.collectionGroup, le(e), e.filters, e.limit, e.startAt, e.endAt); else {
        ...
        // We need to swap the cursors to match the now-flipped query ordering.
                const n = e.endAt ? new ne(e.endAt.position, !e.endAt.before) : null, s = e.startAt ? new ne(e.startAt.position, !e.startAt.before) : null;
        // Now return as a LimitType.First query.
        e.L = Wt(e.path, e.collectionGroup, t, e.filters, e.limit, n, s);
    }
    return e.L;
}
...
function de(t, e) {
    return function(t, e) {
        ...
        for (let n = 0; n < t.orderBy.length; n++) if (!re(t.orderBy[n], e.orderBy[n])) return !1;
...
function ke(t, e) {
    return "found" in e ? function(t, e) {
        ...
        const n = Oe(t, e.found.name), s = Se(e.found.updateTime), r = new Bt({
            mapValue: {
                fields: e.found.fields
            }
        });
        return Qt.newFoundDocument(n, s, r);
...
function Me(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = Ce(t, s), n.structuredQuery.from = [ {
        collectionId: e.collectionGroup,
        allDescendants: !0
    } ]) : (n.parent = Ce(t, s.popLast()), n.structuredQuery.from = [ {
...
async function Ze(t, e) {
    const n = E(t), s = Le(n.k) + "/documents", r = {
        writes: e.map((t => je(n.k, t)))
    };
...
async function tn(t, e) {
    const n = E(t), s = Me(n.k, fe(e));
    return (await n.V("RunQuery", s.parent, {
        structuredQuery: s.structuredQuery
    })).filter((t => !!t.document)).map((t => function(t, e, n) {
        const s = Oe(t, e.name), r = Se(e.updateTime), i = new Bt({
            mapValue: {
                fields: e.fields
            }
        }), o = Qt.newFoundDocument(s, r, i);
...
function nn(t) {
    ...
    if (!en.has(t)) {
        ...
        new H(e, n, s, r.host, r.ssl, r.experimentalForceLongPolling, r.experimentalAutoDetectLongPolling, r.useFetchStreams))), o = Ye(t._databaseId), u = function(t, e, n) {
            return new Je(t, e, n);
        }(t._credentials, i, o);
        en.set(t, u);
    }
 ...
 */ (t), this._credentials = new z(e));
    ...
    _setSettings(t) {
        ...
        this._settings = new sn(t), void 0 !== t.credentials && (this._credentials = function(t) {
            if (!t) return new B;
            switch (t.type) {
              case "gapi":
                const e = t.client;
 ...
 * Security Rules.
 */ function cn(t, e, n, s = {}) {
    const r = (t = it(t, rn))._getSettings();
 ...
 * terminated.
 */ function an(t) {
    return t = it(t, rn), n(t.app, "firestore/lite"), t._delete();
}
...
function dn(t, e, ...n) {
    if (t = a(t), et("collection", "path", e), t instanceof rn) {
        const s = J.fromString(e, ...n);
        return st(s), new fn(t, /* converter= */ null, s);
    }
    {
        ...
        return st(s), new fn(t.firestore, 
        /* converter= */ null, s);
    }
}
 ...
 */ function wn(t, e) {
    if (t = it(t, rn), et("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new k(P, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
    return new ln(t, 
    /* converter= */ null, 
    /**
...
function mn(t, e, ...n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = mt.$()), et("doc", "path", e), t instanceof rn) {
        const s = J.fromString(e, ...n);
        return nt(s), new hn(t, 
        /* converter= */ null, new tt(s));
    }
    {
        if (!(t instanceof hn || t instanceof fn)) throw new k(P, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = t._path.child(J.fromString(e, ...n));
        return nt(s), new hn(t.firestore, t instanceof fn ? t.converter : null, new tt(s));
    }
}
...
/** A "context" object passed around while parsing user data. */ class Rn {
    ...
    /** Returns a new context with the specified settings overwritten. */    ot(t) {
        return new Rn(Object.assign(Object.assign({}, this.settings), t), this.databaseId, this.k, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
    }
    ut(t) {
        var e;
    ...
    rt() {
        ...
        // within arrays.
        if (this.path) for (let t = 0; t < this.path.length; t++) this.at(this.path.get(t));
    }
    at(t) {
        if (0 === t.length) throw this.ft("Document fields must not be empty");
        if (Pn(this.it) && Tn.test(t)) throw this.ft('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ class Vn {
    constructor(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.k = n || Ye(t);
    }
...
/** Parse document data from a set() call. */ function Dn(t, e, n, s, r, i = {}) {
    const o = t.yt(i.merge || i.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, r);
    Bn("Data must be an object, but it was:", o, s);
    const u = jn(s, o);
    let c, a;
...
class qn extends bn {
    ...
    _toFieldTransform(t) {
        const e = Fn(this, t, 
        /*array=*/ !0), n = this._t.map((t => kn(t, e))), s = new ye(n);
...
class xn extends bn {
    ...
    _toFieldTransform(t) {
        const e = Fn(this, t, 
        /*array=*/ !0), n = this._t.map((t => kn(t, e))), s = new _e(n);
        return new ve(t.path, s);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class On extends bn {
    ...
    _toFieldTransform(t) {
        const e = new ge(t.k, we(t.k, this.gt));
...
/** Parse update data from an update() call. */ function Cn(t, e, n, s) {
    const r = t.yt(1 /* Update */ , e, n);
    Bn("Data must be an object, but it was:", r, s);
    const i = [], o = Bt.empty();
    bt(s, ((t, s) => {
        const u = Wn(e, t, n);
    ...
    const u = new Et(i);
    return new An(o, u, r.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function Ln(t, e, n, s, r, i) {
    const o = t.yt(1 /* Update */ , e, n), u = [ Qn(e, s, n) ], c = [ r ];
 ...
 */ function Un(t, e, n, s = !1) {
    return kn(n, t.yt(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */
    return function(t, e) {
        ...
        if (!Pn(e.it)) throw e.ft(`${t._methodName}() can only be used with update() and set()`);
 ...
 */ (t, e), null;
    ...
    e.path && e.fieldMask.push(e.path), t instanceof Array) {
        ...
        if (e.settings.ct && 4 /* ArrayArgument */ !== e.it) throw e.ft("Nested arrays are not supported");
        return function(t, e) {
            const n = [];
            let s = 0;
            for (const r of t) {
    ...
    return function(t, e) {
        ...
        if ("number" == typeof t) return we(e.k, t);
        ...
        if (t instanceof vn) return {
            bytesValue: $e(e.k, t._byteString)
        };
        if (t instanceof hn) {
...
class ns extends ts {
    ...
    _apply(t) {
        const e = Nn(t.firestore), n = function(t, e, n, s, r, i, o) {
            let u;
            if (r.isKeyField()) {
                ...
                if ("in" /* IN */ === i || "not-in" /* NOT_IN */ === i) {
                    ys(o, i);
                    const e = [];
                    for (const n of o) e.push(ps(s, t, n));
                    u = {
                        arrayValue: {
                            values: e
                        }
            ...
            } else "in" /* IN */ !== i && "not-in" /* NOT_IN */ !== i && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== i || ys(o, i), 
            u = Un(n, e, o, 
            /* allowArrays= */ "in" /* IN */ === i || "not-in" /* NOT_IN */ === i);
            const c = Gt.create(r, i, u);
            return function(t, e) {
                if (e.O()) {
                    const n = ae(t);
 ...
 * @returns The created `Query`.
 */ function us(t) {
    return ot("limit", t), new os("limit", t, "F" /* First */);
}
 ...
 * @returns The created `Query`.
 */ function cs(t) {
    return ot("limitToLast", t), new os("limitToLast", t, "L" /* Last */);
}
...
class as extends ts {
    ...
    _apply(t) {
        const e = ms(t, this.type, this.Pt, this.Rt);
        return new ln(t.firestore, t.converter, function(t, e) {
...
function ds(...t) {
    return new fs("endBefore", t, /*before=*/ !0);
}

function ws(...t) {
    return new fs("endAt", t, /*before=*/ !1);
}

/** Helper function to create a bound from a document or fields */ function ms(t, e, n, s) {
    if (n[0] = a(n[0]), n[0] instanceof Yn) return function(t, e, n, s, r) {
        ...
        // results.
                for (const n of le(t)) if (n.field.isKeyField()) i.push(Ct(e, s.key)); else {
        ...
        return function(t, e, n, s, r, i) {
            ...
            for (let i = 0; i < r.length; i++) {
                ...
                if (o[i].field.isKeyField()) {
                    if ("string" != typeof c) throw new k(P, `Invalid query. Expected a string for document ID in ${s}(), but got a ${typeof c}`);
                    if (!he(t) && -1 !== c.indexOf("/")) throw new k(P, `Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to ${s}() must be a plain document ID, but '${c}' contains a slash.`);
 ...
 * document contents.
 */ function bs(t) {
    const e = nn((t = it(t, hn)).firestore), n = new vs(t.firestore);
    return Xe(e, [ t._key ]).then((e => {
        b(1 === e.length);
        const s = e[0];
        return new Yn(t.firestore, n, t._key, s.isFoundDocument() ? s : null, t.converter);
    }));
}
 ...
 */ function Es(t) {
    ...
    const e = nn(t.firestore), n = new vs(t.firestore);
    return tn(e, t._query).then((e => {
        const s = e.map((e => new Kn(t.firestore, n, e.key, e, t.converter)));
        return ue(t._query) && 
        // Limit to last queries reverse the orderBy constraint that was
        // specified by the user. As such, we need to reverse the order of the
        // results to return the documents in the expected order.
        s.reverse(), new Jn(t, s);
    }));
}

function Ts(t, e, n) {
    const s = gs((t = it(t, hn)).converter, e, n), r = Dn(Nn(t.firestore), "setDoc", t._key, s, null !== t.converter, n);
    return Ze(nn(t.firestore), [ r.toMutation(t._key, be.none()) ]);
}

function Is(t, e, n, ...s) {
    const r = Nn((t = it(t, hn)).firestore);
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
        let i;
    i = "string" == typeof (e = a(e)) || e instanceof _n ? Ln(r, "updateDoc", t._key, e, n, s) : Cn(r, "updateDoc", t._key, e);
 ...
 */ function Ps(t, e) {
    const n = mn(t = it(t, fn)), s = gs(t.converter, e), r = Dn(Nn(t.firestore), "addDoc", n._key, s, null !== n.converter, {});
    return Ze(nn(t.firestore), [ r.toMutation(n._key, be.exists(!1)) ]).then((() => n));
}
 ...
 */ class Fs {
    ...
    set(t, e, n) {
        ...
        const s = Ss(t, this._firestore), r = gs(s.converter, e, n), i = Dn(this._dataReader, "WriteBatch.set", s._key, r, null !== s.converter, n);
        return this._mutations.push(i.toMutation(s._key, be.none())), this;
    }
    update(t, e, n, ...s) {
        this._verifyNotCommitted();
        ...
        // performing validation.
                let i;
        return i = "string" == typeof (e = a(e)) || e instanceof _n ? Ln(this._dataReader, "WriteBatch.update", r._key, e, n, s) : Cn(this._dataReader, "WriteBatch.update", r._key, e), 
        this._mutations.push(i.toMutation(r._key, be.exists(!0))), this;
    }
    /**
 ...
 * writes.
 */ function qs(t) {
    const e = nn(t = it(t, rn));
    return new Fs(t, (t => Ze(e, t)));
}
...
class Os {
    constructor(t, e, n, s) {
        ...
        this.Vt = 5, this.Nt = new Ke(this.asyncQueue, "transaction_retry" /* TransactionRetry */);
    }
 ...
 * limitations under the License.
 */
/** The Platform's 'document' implementation or null if not available. */ function Cs() {
 ...
 */ class Ls {
     ...
     */    static createAndSchedule(t, e, n, s, r) {
        const i = Date.now() + n, o = new Ls(t, e, i, s, r);
        return o.start(n), o;
    }
    /**
 ...
 */ class Us {
    constructor() {
        ...
        this.Nt = new Ke(this, "async_queue_retry" /* AsyncQueueRetry */), 
 ...
 */ (t)), t;
    ...
    enqueueAfterDelay(t, e, n) {
        ...
        const s = Ls.createAndSchedule(this, t, e, n, (t => this.zt(t)));
...
class ks {
     ...
     */    get(t) {
        const e = Ss(t, this._firestore), n = new vs(this._firestore);
        return this._transaction.lookup([ e._key ]).then((t => {
            if (!t || 1 !== t.length) return v();
            const s = t[0];
            if (s.isFoundDocument()) return new Yn(this._firestore, n, s.key, s, e.converter);
            if (s.isNoDocument()) return new Yn(this._firestore, n, e._key, null, e.converter);
            throw v();
        }));
    }
    set(t, e, n) {
        const s = Ss(t, this._firestore), r = gs(s.converter, e, n), i = Dn(this._dataReader, "Transaction.set", s._key, r, null !== s.converter, n);
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let i;
        return i = "string" == typeof (e = a(e)) || e instanceof _n ? Ln(this._dataReader, "Transaction.update", r._key, e, n, s) : Cn(this._dataReader, "Transaction.update", r._key, e), 
 ...
 */ function js(t, e) {
    const n = nn(t = it(t, rn)), s = new j;
    return new Os(new Us, n, (n => e(new ks(t, n))), s).run(), s.promise;
}
 ...
 */ !function(t) {
    ...
    const n = t.getProvider("app-exp").getImmediate(), s = new rn(n, t.getProvider("auth-internal"));
    return e && s._setSettings(e), s;
}), "PUBLIC" /* PUBLIC */)), r("firestore-lite", "2.3.4", "node");

export { vn as Bytes, fn as CollectionReference, hn as DocumentReference, Yn as DocumentSnapshot, _n as FieldPath, bn as FieldValue, rn as FirebaseFirestore, k as FirestoreError, En as GeoPoint, ln as Query, ts as QueryConstraint, Kn as QueryDocumentSnapshot, Jn as QuerySnapshot, _t as Timestamp, ks as Transaction, Fs as WriteBatch, Ps as addDoc, Ds as arrayRemove, Ns as arrayUnion, dn as collection, wn as collectionGroup, As as deleteDoc, Rs as deleteField, mn as doc, gn as documentId, ws as endAt, ds as endBefore, bs as getDoc, Es as getDocs, un as getFirestore, $s as increment, on as initializeFirestore, us as limit, cs as limitToLast, is as orderBy, es as query, yn as queryEqual, pn as refEqual, js as runTransaction, Vs as serverTimestamp, Ts as setDoc, m as setLogLevel, Zn as snapshotEqual, ls as startAfter, hs as startAt, an as terminate, Is as updateDoc, cn as useFirestoreEmulator, ss as where, qs as writeBatch };
