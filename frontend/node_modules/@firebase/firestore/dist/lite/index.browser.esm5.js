 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var I = "ok", V = "cancelled", k = "unknown", P = "invalid-argument", D = "deadline-exceeded", N = "not-found", F = "permission-denied", O = "unauthenticated", q = "resource-exhausted", L = "failed-precondition", R = "aborted", C = "out-of-range", U = "unimplemented", j = "internal", x = "unavailable", B = /** @class */ function(e) {
    /** @hideconstructor */
    function n(
    /**
    ...
    function t(t, e, n) {
        this.m = t, this.p = e, this.g = n, this.type = "FirstParty", this.user = y.FIRST_PARTY;
    }
...
function(t, e, n, r, i, o, a, s) {
    ...
    n.fromString = function() {
        ...
        // for legacy reasons and should not be used frequently).
            ...
            var a = o[i];
            if (a.indexOf("//") >= 0) throw new B(P, "Invalid segment (" + a + "). Paths must not contain // in them.");
    ...
    n.fromServerFormat = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new B(P, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            e.push(r), r = "";
        }, a = !1; i < t.length; ) {
            var s = t[i];
            if ("\\" === s) {
                ...
                var u = t[i + 1];
                if ("\\" !== u && "." !== u && "`" !== u) throw new B(P, "Path has invalid escape sequence: " + t);
                r += u, i += 2;
 ...
 */
function nt(t, e, n) {
    if (!n) throw new B(P, "Function " + t + "() cannot be called with an empty " + e + ".");
}
 ...
 */ function rt(t) {
    if (!et.isDocumentKey(t)) throw new B(P, "Invalid document reference. Document references must have an even number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */ function it(t) {
    if (et.isDocumentKey(t)) throw new B(P, "Invalid collection reference. Collection references must have an odd number of segments, but " + t + " has " + t.length + ".");
}
...
e) {
    ...
    t = t._delegate), !(t instanceof e)) {
        ...
        var n = ot(t);
        throw new B(P, "Expected type '" + e.name + "', but it was: " + n);
    }
    return t;
}

function st(t, e) {
    if (e <= 0) throw new B(P, "Function " + t + "() requires a positive number, but it was: " + e + ".");
}
...
function dt(t) {
    ...
    // https://github.com/googleapis/googleapis/blob/master/google/rpc/code.proto
      ...
      default:
        return t >= 200 && t < 300 ? I : t >= 400 && t < 500 ? L : t >= 500 && t < 600 ? j : k;
    }
}
 ...
 */ var Gt = /** @class */ function() {
    ...
    this.startAt = o, this.endAt = a, this.F = null;
};
...
var Wt = /** @class */ function(e) {
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.S(t, e, r) : new Yt(t, e, r) : "array-contains" /* ARRAY_CONTAINS */ === e ? new Zt(t, r) : "in" /* IN */ === e ? new $t(t, r) : "not-in" /* NOT_IN */ === e ? new te(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new ee(t, r) : new n(t, e, r);
    }, n.S = function(t, e, n) {
        return "in" /* IN */ === e ? new Kt(t, n) : new Xt(t, n);
    }, n.prototype.matches = function(t) {
        var e = t.data.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.q(Lt(e, this.value)) : null !== e && Ft(this.value) === Ft(e) && this.q(Lt(e, this.value));
 ...
 */ function he(t) {
    var e = A(t);
    if (!e.L) if ("F" /* First */ === e.limitType) e.L = zt(e.path, e.collectionGroup, le(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        ...
        // Now return as a LimitType.First query.
                e.L = zt(e.path, e.collectionGroup, n, e.filters, e.limit, s, u);
    }
    return e.L;
}
...
/** Used to represent a field transform on a mutation. */ var pe = function() {
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).k = t, r.j = n, r;
    }
    return t(n, e), n;
}(pe), we = function(t, e) {
 ...
 */ var ze = /** @class */ function() {
     ...
     */ , i) {
        ...
        this.M = t, this.timerId = e, this.B = n, this.W = r, this.G = i, this.H = 0, this.Y = null, 
    ...
    t.prototype.Z = function(t) {
        ...
        this.Y = this.M.enqueueAfterDelay(this.timerId, i, (function() {
...
function Ye(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = A(t), i = Ce(e.k) + "/documents", o = {
                ...
                return a = n.sent(), s = new Map, a.forEach((function(t) {
                    var n = function(t, e) {
                        return "found" in e ? function(t, e) {
                            ...
                            var n = Le(t, e.found.name), r = Fe(e.found.updateTime), i = new Gt({
                                mapValue: {
            ...
            switch (n.label) {
              case 0:
                return e = A(t), i = function(t, e) {
                    ...
                    return null !== a && (n.structuredQuery.limit = a), e.startAt && (n.structuredQuery.startAt = je(e.startAt)), 
                    e.endAt && (n.structuredQuery.endAt = je(e.endAt)), n;
                }(e.k, he(r)), [ 4 /*yield*/ , e.V("RunQuery", i.parent, {
              ...
              case 1:
                return [ 2 /*return*/ , n.sent().filter((function(t) {
                    ...
                    return function(t, e, n) {
                        var r = Le(t, e.name), i = Fe(e.updateTime), o = new Gt({
                            mapValue: {
                                fields: e.fields
                            }
                        }), a = Ht.newFoundDocument(r, i, o);
                        return a;
                    }(e.k, t.document);
                })) ];
            }
 ...
 */ function Ze(t) {
    ...
    if (!Je.has(t)) {
        ...
        new K(i, o, a, s.host, s.ssl, s.experimentalForceLongPolling, s.experimentalAutoDetectLongPolling, s.useFetchStreams))), n = Qe(t._databaseId), r = function(t, e, n) {
            return new We(t, e, n);
        }(t._credentials, e, n);
        Je.set(t, r);
    }
 ...
 */ var $e = /** @class */ function() {
    function t(t) {
        ...
        this.useFetchStreams = !!t.useFetchStreams, function(t, e, n, r) {
            if (!0 === e && !0 === r) throw new B(P, "experimentalForceLongPolling and experimentalAutoDetectLongPolling cannot be used together.");
    ...
    return Object.defineProperty(t.prototype, "app", {
        ...
        this._settings = new $e(t), void 0 !== t.credentials && (this._credentials = function(t) {
            ...
            switch (t.type) {
              ...
              default:
                throw new B(P, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(t.credentials));
 ...
 */ function rn(t, e, n, r) {
    ...
    t._setSettings(Object.assign(Object.assign({}, i), {
        ...
        if (!a) throw new B(P, "mockUserToken must contain 'sub' or 'user_id' field!");
        t._credentials = new Q(new G(o, new y(a)));
    }
}
 ...
 */ function cn(t, e) {
    ...
    if (!(t instanceof an || t instanceof un)) throw new B(P, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
 ...
 */ function fn(t, e) {
    if (t = at(t, tn), nt("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new B(P, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
    return new sn(t, 
    /* converter= */ null, 
    /**
...
function ln(t, e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = yt.$()), nt("doc", "path", e), t instanceof tn) {
        var o = Z.fromString.apply(Z, r([ e ], n));
...
/** A "context" object passed around while parsing user data. */ var Sn = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.ot = function(e) {
        ...
        return Gn(t, this.settings.methodName, this.settings.dt || !1, this.path, this.settings.wt);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (Tn(this.it) && wn.test(t)) throw this.ft('Document fields cannot begin and end with "__"');
    }, t;
}(), En = /** @class */ function() {
    function t(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.k = n || Qe(t)
...
/** Parse document data from a set() call. */ function In(t, e, n, r, i, o) {
    void 0 === o && (o = {});
    var a = t.yt(o.merge || o.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    jn("Data must be an object, but it was:", a, r);
    var s, u, c = Cn(r, a);
    if (o.merge) s = new St(a.fieldMask), u = a.fieldTransforms; else if (o.mergeFields) {
        for (var f = [], l = 0, h = o.mergeFields; l < h.length; l++) {
            var d = xn(e, h[l], n);
            if (!a.contains(d)) throw new B(P, "Field '" + d + "' is specified in your field mask but missing from your input data.");
            Hn(f, d) || f.push(d);
        }
...
var Pn = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = new ge(t.k, de(t.k, this.gt));
...
/** Parse update data from an update() call. */ function On(t, e, n, r) {
    ...
    jn("Data must be an object, but it was:", i, r);
    var o = [], a = Gt.empty();
    Tt(r, (function(t, r) {
        var s = Mn(e, t, n);
...
/** Parse update data from a list of field/value arguments. */ function qn(t, e, n, r, i, o) {
    var a = t.yt(1 /* Update */ , e, n), s = [ xn(e, r, n) ], u = [ i ];
    if (o.length % 2 != 0) throw new B(P, "Function " + e + "() needs to be called with an even number of arguments that alternate between field names and values.");
    for (var c = 0; c < o.length; c += 2) s.push(xn(e, o[c])), u.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var f = [], l = Gt.empty(), d = s.length - 1; d >= 0; --d) if (!Hn(f, s[d])) {
        var p = s[d], m = u[d];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        m = h(m);
 ...
 */ function Ln(t, e, n, r) {
    return void 0 === r && (r = !1), Rn(n, t.yt(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Rn(t, e) {
    ...
    // from firestore-exp.
    t = h(t))) return jn("Unsupported field value:", e, t), Cn(t, e);
    if (t instanceof vn) 
 ...
 */
function Yn(t, e) {
    return t = h(t), e = h(e), t instanceof Qn && e instanceof Qn ? t._firestore === e._firestore && t._key.isEqual(e._key) && (null === t._document ? null === e._document : t._document.isEqual(e._document)) && t._converter === e._converter : t instanceof Wn && e instanceof Wn && dn(t.query, e.query) && gt(t.docs, e.docs, Yn)
    /**
 * Helper that calls fromDotSeparatedString() but wraps any error thrown.
 */;
}
...
var Zn = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        var e = An(t.firestore), n = function(t, e, n, r, i, o, a) {
            var s;
            if (i.isKeyField()) {
                if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new B(P, "Invalid Query. You can't perform '" + o + "' queries on FieldPath.documentId().");
            ...
            return function(t, e) {
                if (e.O()) {
                    var n = ce(t);
                    if (null !== n && !n.isEqual(e.field)) throw new B(P, "Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '" + n.toString() + "' and '" + e.field.toString() + "'");
                    var r = ue(t);
 ...
 */
                ...
                throw i === e.op ? new B(P, "Invalid query. You cannot use more than one '" + e.op.toString() + "' filter.") : new B(P, "Invalid query. You cannot use '" + e.op.toString() + "' filters with '" + i.toString() + "' filters.");
            }(t, h), h;
...
var or = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        var e = lr(t, this.type, this.Pt, this.Rt);
        return new sn(t.firestore, t.converter, function(t, e) {
...
/** Helper function to create a bound from a document or fields */ function lr(t, e, n, r) {
    if (n[0] = h(n[0]), n[0] instanceof Qn) return function(t, e, n, r, i) {
        ...
        for (var o = [], a = 0, s = le(t); a < s.length; a++) {
            var u = s[a];
            if (u.field.isKeyField()) o.push(Ct(e, r.key)); else {
                var c = r.data.field(u.field);
                if (Pt(c)) throw new B(P, 'Invalid query. You are trying to start or end a query using a document for which the field "' + u.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
                    var f = u.field.canonicalString();
                    throw new B(P, "Invalid query. You are trying to start or end a query using a document for which the field '" + f + "' (used as the orderBy) does not exist.");
                }
                o.push(c);
            }
        }
    ...
    return function(t, e, n, r, i, o) {
        ...
        if (i.length > a.length) throw new B(P, "Too many arguments provided to " + r + "(). The number of arguments must be less than or equal to the number of orderBy() clauses");
        for (var s = [], u = 0; u < i.length; u++) {
            var c = i[u];
            if (a[u].field.isKeyField()) {
                if ("string" != typeof c) throw new B(P, "Invalid query. Expected a string for document ID in " + r + "(), but got a " + typeof c);
                if (!fe(t) && -1 !== c.indexOf("/")) throw new B(P, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                var f = t.path.child(Z.fromString(c));
                if (!et.isDocumentKey(f)) throw new B(P, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + f + "' is not because it contains an odd number of segments.");
                var l = new et(f);
                s.push(Ct(e, l));
            } else {
                var h = Ln(n, r, c);
...
function hr(t, e, n) {
    if ("string" == typeof (n = h(n))) {
        if ("" === n) throw new B(P, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!fe(e) && -1 !== n.indexOf("/")) throw new B(P, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(Z.fromString(n));
        if (!et.isDocumentKey(r)) throw new B(P, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return Ct(t, new et(r));
    }
    if (n instanceof an) return Ct(t, n._key);
    throw new B(P, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + ot(n) + ".");
}
 ...
 * array requirements.
 */ function dr(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new B(P, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
    if (t.length > 10) throw new B(P, "Invalid Query. '" + e.toString() + "' filters support a maximum of 10 elements in the value array.");
}

function pr(t, e, n) {
    if (!n.isEqual(e)) throw new B(P, "Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '" + e.toString() + "' and so you must also use '" + e.toString() + "' as your first argument to orderBy(), but your first orderBy() is on field '" + n.toString() + "' instead.");
}
 ...
 */ function gr(t) {
    !function(t) {
        if (se(t) && 0 === t.explicitOrderBy.length) throw new B(U, "limitToLast() queries require specifying at least one orderBy() clause");
    }((t = at(t, sn))._query);
...
function wr(t, e, n) {
    ...
    return Ye(Ze(t.firestore), [ i.toMutation(t._key, be.none()) ]);
}
...
function br(t, e, n) {
    ...
    Ye(Ze(t.firestore), [ o.toMutation(t._key, be.exists(!0)) ]);
}
 ...
 */ function _r(t) {
    return Ye(Ze((t = at(t, an)).firestore), [ new Ee(t._key, be.none()) ]);
}
 ...
 */ function Tr(t, e) {
    ...
    return Ye(Ze(t.firestore), [ i.toMutation(n._key, be.exists(!1)) ]).then((function() {
        return n;
    }));
}
 ...
 */ var kr = /** @class */ function() {
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        var r = Pr(t, this._firestore), i = mr(r.converter, e, n), o = In(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
...
function Pr(t, e) {
    if ((t = h(t)).firestore !== e) throw new B(P, "Provided document reference is from a different Firestore instance.");
    return t;
}
 ...
 */ var Nr = /** @class */ function() {
    ...
    function t(t, e, n, r) {
        ...
        this.Vt = 5, this.Nt = new ze(this.asyncQueue, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.Nt.Z((function() {
            return e(t, void 0, void 0, (function() {
                var t, e, r = this;
                return n(this, (function(n) {
                    return t = new Nr(this.datastore), (e = this.$t(t)) && e.then((function(e) {
 ...
 */ var qr = /** @class */ function() {
    ...
    function t() {
        ...
        this.Nt = new ze(this, "async_queue_retry" /* AsyncQueueRetry */), 
    ...
    t.prototype.enqueueAndForget = function(t) {
        ...
        if (!this.Ot) {
            this.Ot = !0;
            var t = Or();
            t && "function" == typeof t.removeEventListener && t.removeEventListener("visibilitychange", this.jt);
        }
    }, t.prototype.enqueue = function(t) {
        return this.Mt(), this.Ot ? new Promise((function(t) {})) : this.Bt(t);
    }, t.prototype.enqueueRetryable = function(t) {
        var e = this;
        this.enqueueAndForget((function() {
            return e.xt.push(t), e.Qt();
        }));
    }, 
    /**
    ...
    t.prototype.Qt = function() {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (0 === this.xt.length) return [ 3 /*break*/ , 5 ];
                    n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.xt[0]() ];

                  case 2:
                    return n.sent(), this.xt.shift(), this.Nt.reset(), [ 3 /*break*/ , 4 ];
        ...
        var e = this, n = this.qt.then((function() {
 ...
 */
    ...
    t.prototype.Wt = function() {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return [ 4 /*yield*/ , t = this.qt ];

                  case 1:
                    e.sent(), e.label = 2;

                  case 2:
                    if (t !== this.qt) return [ 3 /*break*/ , 0 ];
                    e.label = 3;
    ...
    return t.prototype.get = function(t) {
        ...
        var r = Pr(t, this._firestore), i = mr(r.converter, e, n), o = In(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
...
function Cr(t, e) {
    ...
    return new Fr(new Lr, n, (function(n) {
        return e(new Rr(t, n));
    }), r).run(), r.promise
    /**
 * Firestore Lite
...
}), "PUBLIC" /* PUBLIC */)), c("firestore-lite", "2.3.4", "node");

export { yn as Bytes, un as CollectionReference, an as DocumentReference, Qn as DocumentSnapshot, pn as FieldPath, vn as FieldValue, tn as FirebaseFirestore, B as FirestoreError, gn as GeoPoint, sn as Query, Xn as QueryConstraint, zn as QueryDocumentSnapshot, Wn as QuerySnapshot, wt as Timestamp, Rr as Transaction, kr as WriteBatch, Tr as addDoc, Ir as arrayRemove, Ar as arrayUnion, cn as collection, fn as collectionGroup, _r as deleteDoc, Sr as deleteField, ln as doc, mn as documentId, fr as endAt, cr as endBefore, vr as getDoc, gr as getDocs, nn as getFirestore, Vr as increment, en as initializeFirestore, rr as limit, ir as limitToLast, er as orderBy, Jn as query, dn as queryEqual, hn as refEqual, Cr as runTransaction, Er as serverTimestamp, wr as setDoc, g as setLogLevel, Yn as snapshotEqual, sr as startAfter, ar as startAt, on as terminate, br as updateDoc, rn as useFirestoreEmulator, $n as where, Dr as writeBatch };
