                    ...
                    <div className="row mt-2">
                        <div className="col-md-4 services-item">
                            <div className="">
                                ...
                                <p data-testid="paragraph1">This course teaches the basics of money and currency used throughout the world and how we are evolving economically into a cryptocurrency space. 
                        ...
                        <div className="col-md-4 services-item">
                            <div className="">
                                ...
                                <p data-testid="paragraph2">This course allows students to identify their personal interests and possible career aspirations to uncover strategies to earn income through entrepreneurship. 
                        ...
                        <div className="col-md-4 services-item">
                            <div className="">
                                <img data-testid="image3" className="services-img img-fluid img-thumbnail" src={'https://i.imgur.com/lrRP2aA.jpg'} alt="Academic Coaching"  width="600px" height="250px"/>
                                <br/><br/>
                                <h5 data-testid="header3" className="services-subtitle">Academic Coaching</h5>
                                <p data-testid="paragraph3">This program is for students who will thrive from having personalized guidance from an educational professional during the school year. Coaches meet with students 
