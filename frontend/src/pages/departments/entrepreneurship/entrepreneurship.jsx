        ...
        <div className="row align-items-center h-100">
          <div className="col-6 mx-auto">
            ...
            <div className="headline quote text-center">
              ...
              <q>
                This course allows students to identify their personal interests
                and possible career aspirations to uncover strategies to earn
                income through entrepreneurship. This course is currently
                virtual.
              </q>
            </div>
          </div>
